...
!(function (t, e) {
  ...
  function c(t, e, n) {
    ...
    if ('string' == typeof e) {
      ...
      if (Mt.test(e)) return Q.filter(e, i, !n);
      e = Q.filter(e, i);
    }
    return Q.grep(t, function (t, i) {
  ...
  function p(t, e) {
    if (1 === e.nodeType && Q.hasData(t)) {
      ...
      if (s) {
        ...
        for (n in s) for (i = 0, r = s[n].length; i < r; i++) Q.event.add(e, n, s[n][i]);
      }
  ...
  function y(t, e) {
    for (var n, i, r = [], a = 0, o = t.length; a < o; a++)
      (n = t[a]),
        n.style &&
          ((r[a] = Q._data(n, 'olddisplay')),
          e
            ? (!r[a] && 'none' === n.style.display && (n.style.display = ''),
              '' === n.style.display && g(n) && (r[a] = Q._data(n, 'olddisplay', k(n.nodeName))))
            : ((i = ne(n, 'display')), !r[a] && 'none' !== i && Q._data(n, 'olddisplay', i)));
    for (a = 0; a < o; a++)
      (n = t[a]), n.style && ((e && 'none' !== n.style.display && '' !== n.style.display) || (n.style.display = e ? r[a] || '' : 'none'));
    return t;
  }
  function b(t, e, n) {
    var i = ue.exec(e);
  ...
  function _(t, e, n, i) {
    for (var r = n === (i ? 'border' : 'content') ? 4 : 'width' === e ? 1 : 0, a = 0; r < 4; r += 2)
      'margin' === n && (a += Q.css(t, n + me[r], !0)),
        i
          ? ('content' === n && (a -= parseFloat(ne(t, 'padding' + me[r])) || 0),
            'margin' !== n && (a -= parseFloat(ne(t, 'border' + me[r] + 'Width')) || 0))
          : ((a += parseFloat(ne(t, 'padding' + me[r])) || 0),
  ...
  function x(t, e, n) {
    ...
    if (i <= 0 || null == i) {
      ...
      (r = a && (Q.support.boxSizingReliable || i === t.style[e])), (i = parseFloat(i) || 0);
    }
  ...
  function k(t) {
    ...
    return (
      e.remove(),
      ('none' !== n && '' !== n) ||
        ((ie = B.body.appendChild(
          ie ||
            Q.extend(B.createElement('iframe'), {
              frameBorder: 0,
              width: 0,
              height: 0,
            })
        ...
        (re && ie.createElement) ||
          ((re = (ie.contentWindow || ie.contentDocument).document), re.write('<!doctype html><html><body>'), re.close()),
  ...
  function C(t) {
    return function (e, n) {
      ...
      var i,
        r,
        a,
        o = e.toLowerCase().split(et),
        s = 0,
        l = o.length;
      if (Q.isFunction(n))
        for (; s < l; s++)
          (i = o[s]), (a = /^\+/.test(i)), a && (i = i.substr(1) || '*'), (r = t[i] = t[i] || []), r[a ? 'unshift' : 'push'](n);
    };
  }
  function $(t, n, i, r, a, o) {
    (a = a || n.dataTypes[0]), (o = o || {}), (o[a] = !0);
    for (var s, l = t[a], c = 0, u = l ? l.length : 0, d = t === Me; c < u && (d || !s); c++)
      'string' == typeof (s = l[c](n, i, r)) && (!d || o[s] ? (s = e) : (n.dataTypes.unshift(s), (s = $(t, n, i, r, s, o))));
    return (d || !s) && !o['*'] && (s = $(t, n, i, r, '*', o)), s;
  }
  function S(t, n) {
    var i,
      r,
      a = Q.ajaxSettings.flatOptions || {};
  ...
  function T(t, n, i) {
    ...
    for (; '*' === c[0]; ) c.shift(), r === e && (r = t.mimeType || n.getResponseHeader('content-type'));
    if (r)
      for (a in l)
        if (l[a] && l[a].test(r)) {
          c.unshift(a);
  ...
  function E(t, e) {
    var n,
      ...
      l = {},
      c = 0;
    if ((t.dataFilter && (e = t.dataFilter(e, t.dataType)), o[1])) for (n in t.converters) l[n.toLowerCase()] = t.converters[n];
    for (; (r = o[++c]); )
      if ('*' !== r) {
        if ('*' !== s && s !== r) {
          if (!(n = l[s + ' ' + r] || l['* ' + r]))
            for (i in l)
              if (((a = i.split(' ')), a[1] === r && (n = l[s + ' ' + a[0]] || l['* ' + a[0]]))) {
                !0 === n ? (n = l[i]) : !0 !== l[i] && ((r = a[0]), o.splice(c--, 0, r));
                break;
              }
          if (!0 !== n)
            if (n && t.throws) e = n(e);
  ...
  function O(t, e) {
    Q.each(e, function (e, n) {
      for (var i = (Qe[e] || []).concat(Qe['*']), r = 0, a = i.length; r < a; r++) if (i[r].call(t, e, n)) return;
    });
  }
  function D(t, e, n) {
    var i,
      r = 0,
      a = Ge.length,
      o = Q.Deferred().always(function () {
        delete s.elem;
      }),
      s = function () {
        for (
          var e = We || N(), n = Math.max(0, l.startTime + l.duration - e), i = n / l.duration || 0, r = 1 - i, a = 0, s = l.tweens.length;
          a < s;
          a++
        )
          l.tweens[a].run(r);
      ...
      c = l.props;
    for (L(c, l.opts.specialEasing); r < a; r++) if ((i = Ge[r].call(l, t, c, l.opts))) return i;
    return (
      O(l, c),
    ...
    n.queue ||
      ...
      1 === t.nodeType &&
        ...
        'inline' === Q.css(t, 'display') &&
          'none' === Q.css(t, 'float') &&
          (Q.support.inlineBlockNeedsLayout && 'inline' !== k(t.nodeName) ? (f.zoom = 1) : (f.display = 'inline-block'))),
      n.overflow &&
        ((f.overflow = 'hidden'),
    ...
    if ((o = v.length)) {
      ...
      for (i = 0; i < o; i++)
        (r = v[i]),
          ...
          (h[r] = s[r] || Q.style(t, r)),
          r in s || ((s[r] = c.start), m && ((c.end = c.start), (c.start = 'width' === r || 'height' === r ? 1 : 0)));
    }
  }
  ...
  function P(t, e) {
    var n,
      ...
      r = 0;
    for (e = e ? 1 : 0; r < 4; r += 2 - e) (n = me[r]), (i['margin' + n] = i['padding' + n] = t);
  ...
  var q,
    ...
    pt = function () {
      B.addEventListener
        ? (B.removeEventListener('DOMContentLoaded', pt, !1), Q.ready())
        : 'complete' === B.readyState && (B.detachEvent('onreadystatechange', pt), Q.ready());
    },
    ft = {};
  (Q.fn = Q.prototype =
    {
    ...
    (Q.extend = Q.fn.extend =
      function () {
        var t,
          ...
          u = !1;
        for (
          'boolean' == typeof s && ((u = s), (s = arguments[1] || {}), (l = 2)),
          ...
          if (null != (t = arguments[l]))
            for (n in t)
              (i = s[n]),
                (r = t[n]),
                s !== r &&
                  (u && r && (Q.isPlainObject(r) || (a = Q.isArray(r)))
                    ? (a ? ((a = !1), (o = i && Q.isArray(i) ? i : [])) : (o = i && Q.isPlainObject(i) ? i : {}),
                      (s[n] = Q.extend(u, o, r)))
                    : r !== e && (s[n] = r));
        return s;
      }),
    Q.extend({
      noConflict: function (e) {
        return t.$ === Q && (t.$ = V), e && t.jQuery === Q && (t.jQuery = U), Q;
      },
      isReady: !1,
      readyWait: 1,
      ...
      ready: function (t) {
        if (!0 === t ? !--Q.readyWait : !Q.isReady) {
          ...
          (Q.isReady = !0), (!0 !== t && --Q.readyWait > 0) || (H.resolveWith(B, [Q]), Q.fn.trigger && Q(B).trigger('ready').off('ready'));
        }
      },
      ...
      parseJSON: function (e) {
        return e && 'string' == typeof e
          ? ((e = Q.trim(e)),
            t.JSON && t.JSON.parse
              ? t.JSON.parse(e)
              : at.test(e.replace(st, '@').replace(lt, ']').replace(ot, ''))
      ...
      each: function (t, n, i) {
        var r,
          a = 0,
          o = t.length,
          s = o === e || Q.isFunction(t);
        if (i)
          if (s) {
            for (r in t) if (!1 === n.apply(t[r], i)) break;
          } else for (; a < o && !1 !== n.apply(t[a++], i); );
        else if (s) {
          for (r in t) if (!1 === n.call(t[r], r, t[r])) break;
        } else for (; a < o && !1 !== n.call(t[a], a, t[a++]); );
        return t;
      },
      trim:
        G && !G.call('\ufeff ')
      ...
      merge: function (t, n) {
        var i = n.length,
          r = t.length,
          a = 0;
        if ('number' == typeof i) for (; a < i; a++) t[r++] = n[a];
        else for (; n[a] !== e; ) t[r++] = n[a++];
        return (t.length = r), t;
      },
      grep: function (t, e, n) {
        var i,
      ...
      map: function (t, n, i) {
        ...
        else for (a in t) null != (r = n(t[a], a, i)) && (o[o.length] = r);
      ...
      access: function (t, n, i, r, a, o, s) {
        ...
        if (i && 'object' == typeof i) {
          for (u in i) Q.access(t, n, u, i[u], 1, o, r);
          a = 1;
        } else if (r !== e) {
          if (
            ((l = s === e && Q.isFunction(r)),
            c &&
              (l
                ? ((l = n),
                  (n = function (t, e, n) {
            ...
            for (; u < d; u++) n(t[u], i, l ? r.call(t[u], u, n(t[u], i)) : r, s);
          a = 1;
        }
    ...
    (Q.ready.promise = function (e) {
      if (!H)
        if (((H = Q.Deferred()), 'complete' === B.readyState)) setTimeout(Q.ready, 1);
        else if (B.addEventListener) B.addEventListener('DOMContentLoaded', pt, !1), t.addEventListener('load', Q.ready, !1);
        else {
  ...
  (Q.Callbacks = function (t) {
    ...
    var i,
      ...
      u = !t.once && [],
      d = function (e) {
        for (i = t.memory && e, r = !0, l = o || 0, o = 0, s = c.length, a = !0; c && l < s; l++)
          if (!1 === c[l].apply(e[0], e[1]) && t.stopOnFalse) {
            i = !1;
            break;
          }
        (a = !1), c && (u ? u.length && d(u.shift()) : i ? (c = []) : p.disable());
      },
      p = {
        add: function () {
          if (c) {
          ...
          return (
            c &&
              Q.each(arguments, function (t, e) {
                for (var n; (n = Q.inArray(e, c, n)) > -1; ) c.splice(n, 1), a && (n <= s && s--, n <= l && l--);
              }),
            this
          );
        },
        ...
        fireWith: function (t, e) {
          return (e = e || []), (e = [t, e.slice ? e.slice() : e]), c && (!r || u) && (a ? u.push(e) : d(e)), this;
        },
        fire: function () {
    ...
    Q.extend({
      ...
      when: function (t) {
        var e,
          ...
          a = X.call(arguments),
          o = a.length,
          s = 1 !== o || (t && Q.isFunction(t.promise)) ? o : 0,
          l = 1 === s ? t : Q.Deferred(),
          c = function (t, n, i) {
            return function (r) {
              (n[t] = this),
        ...
        if (o > 1)
          for (e = new Array(o), n = new Array(o), i = new Array(o); r < o; r++)
  ...
  Q.extend({
    ...
    data: function (t, n, i, r) {
      if (Q.acceptData(t)) {
        ...
        if ((d && u[d] && (r || u[d].data)) || !l || i !== e)
          return (
            d || (c ? (t[s] = d = Q.deletedIds.pop() || Q.guid++) : (d = s)),
            u[d] || ((u[d] = {}), c || (u[d].toJSON = Q.noop)),
    ...
    removeData: function (t, e, n) {
      if (Q.acceptData(t)) {
        ...
        if (l[c]) {
          ...
          (n || (delete l[c].data, r(l[c]))) &&
            (s ? Q.cleanData([t], !0) : Q.support.deleteExpando || l != l.window ? delete l[c] : (l[c] = null));
        }
      }
    },
      ...
      data: function (t, n) {
        ...
        if (t === e) {
          if (this.length && ((d = Q.data(c)), 1 === c.nodeType && !Q._data(c, 'parsedAttrs'))) {
            for (o = c.attributes, l = o.length; u < l; u++)
              (s = o[u].name), s.indexOf('data-') || ((s = Q.camelCase(s.substring(5))), i(c, s, d[s]));
          ...
          : ((r = t.split('.', 2)),
            ...
            Q.access(
              ...
              function (n) {
                if (n === e)
                  return (
                    (d = this.triggerHandler('getData' + a, [r[0]])),
                    d === e && c && ((d = Q.data(c, t)), (d = i(c, t, d))),
                    d === e && r[1] ? this.data(r[0]) : d
                  );
                (r[1] = n),
                  this.each(function () {
                    var e = Q(this);
                    e.triggerHandler('setData' + a, r), Q.data(this, t, n), e.triggerHandler('changeData' + a, r);
                  });
              },
              null,
              n,
    ...
    Q.extend({
      ...
      dequeue: function (t, e) {
        ...
        'inprogress' === r && ((r = n.shift()), i--),
          r && ('fx' === e && n.unshift('inprogress'), delete a.stop, r.call(t, o, a)),
          !i && a && a.empty.fire();
      },
    ...
    Q.fn.extend({
      ...
      promise: function (t, n) {
        ...
        for ('string' != typeof t && ((n = t), (t = e)), t = t || 'fx'; s--; )
          (i = Q._data(o[s], t + 'queueHooks')) && i.empty && (r++, i.empty.add(l));
  ...
  Q.fn.extend({
      ...
      if ((t && 'string' == typeof t) || t === e)
        for (n = (t || '').split(et), s = 0, l = this.length; s < l; s++)
          if (((r = this[s]), 1 === r.nodeType && r.className)) {
            for (i = (' ' + r.className + ' ').replace(_t, ' '), a = 0, o = n.length; a < o; a++)
    ...
    val: function (t) {
        ...
        a = this[0];
      {
          ...
          return (
            ...
            this.each(function (i) {
              var a,
                o = Q(this);
              1 === this.nodeType &&
                ((a = r ? t.call(this, i, o.val()) : t),
                null == a
                  ? (a = '')
                  : 'number' == typeof a
                  ? (a += '')
                  : Q.isArray(a) &&
                    (a = Q.map(a, function (t) {
                      return null == t ? '' : t + '';
                    })),
        ...
        if (a)
          return (
            (n = Q.valHooks[a.type] || Q.valHooks[a.nodeName.toLowerCase()]),
            n && 'get' in n && (i = n.get(a, 'value')) !== e
              ? i
              : ((i = a.value), 'string' == typeof i ? i.replace(xt, '') : null == i ? '' : i)
          );
      }
    },
  }),
    Q.extend({
      ...
      attr: function (t, n, i, r) {
        var a,
          ...
          l = t.nodeType;
        if (t && 3 !== l && 8 !== l && 2 !== l)
          return r && Q.isFunction(Q.fn[n])
            ? Q(t)[n](i)
            : void 0 === t.getAttribute
            ? Q.prop(t, n, i)
            : ((s = 1 !== l || !Q.isXMLDoc(t)) && ((n = n.toLowerCase()), (o = Q.attrHooks[n] || ($t.test(n) ? yt : gt))),
              i !== e
                ? null === i
                  ? void Q.removeAttr(t, n)
                  : o && 'set' in o && s && (a = o.set(t, i, n)) !== e
                  ? a
                  : (t.setAttribute(n, i + ''), i)
                : o && 'get' in o && s && null !== (a = o.get(t, n))
                ? a
                : ((a = t.getAttribute(n)), null === a ? e : a));
      },
      removeAttr: function (t, e) {
        ...
        if (e && 1 === t.nodeType)
          for (i = e.split(et); o < i.length; o++)
            (r = i[o]) &&
              ((n = Q.propFix[r] || r), (a = $t.test(r)), a || Q.attr(t, r, ''), t.removeAttribute(St ? r : n), a && n in t && (t[n] = !1));
      },
      attrHooks: {
        type: {
          set: function (t, e) {
            if (kt.test(t.nodeName) && t.parentNode) Q.error("type property can't be changed");
      ...
      prop: function (t, n, i) {
        ...
        if (t && 3 !== s && 8 !== s && 2 !== s)
          return (
            (o = 1 !== s || !Q.isXMLDoc(t)),
            o && ((n = Q.propFix[n] || n), (a = Q.propHooks[n])),
            i !== e
              ? a && 'set' in a && (r = a.set(t, i, n)) !== e
                ? r
                : (t[n] = i)
              : a && 'get' in a && null !== (r = a.get(t, n))
              ? r
              : t[n]
          );
      },
      ...
      (gt = Q.valHooks.button =
        {
          ...
          set: function (t, e, n) {
            ...
            return i || ((i = B.createAttribute(n)), t.setAttributeNode(i)), (i.value = e + '');
          },
        }),
  ...
  (Q.event = {
        ...
        for (
          ...
          (u = Et.exec(n[c]) || []),
            ...
            v ||
              ((v = l[d] = []),
              (v.delegateCount = 0),
              (m.setup && !1 !== m.setup.call(t, r, p, s)) ||
                (t.addEventListener ? t.addEventListener(d, s, !1) : t.attachEvent && t.attachEvent('on' + d, s))),
    ...
    remove: function (t, e, n, i, r) {
      ...
      if (m && (p = m.events)) {
        for (e = Q.trim(Dt(e || '')).split(' '), a = 0; a < e.length; a++)
          if (((o = Et.exec(e[a]) || []), (s = l = o[1]), (c = o[2]), s)) {
            for (
              f = Q.event.special[s] || {},
              ...
              (v = h[d]),
                (r || l === v.origType) &&
                  ...
                  (h.splice(d--, 1), v.selector && h.delegateCount--, f.remove && f.remove.call(t, v));
            0 === h.length &&
              u !== h.length &&
              ((!f.teardown || !1 === f.teardown.call(t, c, m.handle)) && Q.removeEvent(t, s, m.handle), delete p[s]);
          } else for (s in p) Q.event.remove(t, s + e[a], n, i, !0);
    ...
    trigger: function (n, i, r, a) {
      if (!r || (3 !== r.nodeType && 8 !== r.nodeType)) {
        var o,
          ...
          m = n.type || n,
          g = [];
        if (Ot.test(m + Q.event.triggered)) return;
        if (
        ...
        if (
          ...
          o = Q.cache;
          for (l in o) o[l].events && o[l].events[m] && Q.event.trigger(n, i, o[l].handle.elem, !0);
          return;
        }
        if (
          ((n.result = e),
          ...
          return;
        if (((h = [[r, p.bindType || m]]), !a && !p.noBubble && !Q.isWindow(r))) {
          for (v = p.delegateType || m, c = Ot.test(v + m) ? r : r.parentNode, u = r; c; c = c.parentNode) h.push([c, v]), (u = c);
        ...
        return (
          ...
          !a &&
            ...
            (!p._default || !1 === p._default.apply(r.ownerDocument, i)) &&
            ('click' !== m || !Q.nodeName(r, 'a')) &&
            Q.acceptData(r) &&
            d &&
            r[m] &&
            (('focus' !== m && 'blur' !== m) || 0 !== n.target.offsetWidth) &&
            !Q.isWindow(r) &&
            ((u = r[d]), u && (r[d] = null), (Q.event.triggered = m), r[m](), (Q.event.triggered = e), u && (r[d] = u)),
          n.result
        );
      }
    },
      ...
      if (((h[0] = n), (n.delegateTarget = this), !m.preDispatch || !1 !== m.preDispatch.call(this, n))) {
        ...
        for (
          p.length > f &&
            ...
            i = 0;
          i < g.length && !n.isPropagationStopped();
          i++
        )
          for (l = g[i], n.currentTarget = l.elem, r = 0; r < l.matches.length && !n.isImmediatePropagationStopped(); r++)
            (u = l.matches[r]),
              (v || (!n.namespace && !u.namespace) || (n.namespace_re && n.namespace_re.test(u.namespace))) &&
                ((n.data = u.data),
                (n.handleObj = u),
                (o = ((Q.event.special[u.origType] || {}).handle || u.handler).apply(l.elem, h)) !== e &&
                  ((n.result = o), !1 === o && (n.preventDefault(), n.stopPropagation())));
    ...
    fix: function (t) {
      ...
      for (t = Q.Event(i), e = a.length; e; ) (n = a[--e]), (t[n] = i[n]);
      return (
        t.target || (t.target = i.srcElement || B),
    ...
    (Q.removeEvent = B.removeEventListener
      ? function (t, e, n) {
    ...
    (Q.Event = function (t, e) {
      ...
      t && t.type
        ? ((this.originalEvent = t),
          (this.type = t.type),
          (this.isDefaultPrevented = t.defaultPrevented || !1 === t.returnValue || (t.getPreventDefault && t.getPreventDefault()) ? o : a))
        : (this.type = t),
        e && Q.extend(this, e),
        ...
        Q.event.special[t] = {
          ...
          handle: function (t) {
            var n,
              ...
              a = t.handleObj;
            a.selector;
            return (r && (r === i || Q.contains(i, r))) || ((t.type = a.origType), (n = a.handler.apply(this, arguments)), (t.type = e)), n;
          },
        };
      }
    ),
    ...
    Q.fn.extend({
      on: function (t, n, i, r, o) {
        ...
        if (
          (null == i && null == r
            ? ((r = n), (i = n = e))
            : null == r && ('string' == typeof n ? ((r = i), (i = e)) : ((r = i), (i = n), (n = e))),
          !1 === r)
        )
          r = a;
    ...
    (function (t, e) {
      function n(t, e, n, i) {
        ...
        if (!(o = x(e)) && !i && (r = et.exec(t)))
          if ((s = r[1])) {
            ...
            } else if (e.ownerDocument && (a = e.ownerDocument.getElementById(s)) && k(e, a) && a.id === s) return n.push(a), n;
          } else {
            if (r[2]) return M.apply(n, P.call(e.getElementsByTagName(t), 0)), n;
            if ((s = r[3]) && dt && e.getElementsByClassName) return M.apply(n, P.call(e.getElementsByClassName(s), 0)), n;
          }
      ...
      function s(t, e) {
        ...
        for (s = t, l = [], c = b.preFilter; s; ) {
          (i && !(r = G.exec(s))) || (r && (s = s.slice(r[0].length) || s), l.push((a = []))),
            (i = !1),
            (r = Z.exec(s)) && (a.push((i = new j(r.shift()))), (s = s.slice(i.length)), (i.type = r[0].replace(K, ' ')));
          for (o in b.filter)
            (r = ot[o].exec(s)) &&
              (!c[o] || (r = c[o](r))) &&
              (a.push((i = new j(r.shift()))), (s = s.slice(i.length)), (i.type = o), (i.matches = r));
          if (!i) break;
        }
      ...
      function l(t, e, n) {
        ...
        return e.first
          ? function (e, n, a) {
              for (; (e = e[i]); ) if (r || 1 === e.nodeType) return t(e, n, a);
            }
          : function (e, n, o) {
              if (o) {
                for (; (e = e[i]); ) if ((r || 1 === e.nodeType) && t(e, n, o)) return e;
              } else
                for (var s, l = D + ' ' + a + ' ', c = l + g; (e = e[i]); )
                  if (r || 1 === e.nodeType) {
                    if ((s = e[A]) === c) return e.sizset;
                    if ('string' == typeof s && 0 === s.indexOf(l)) {
                      if (e.sizset) return e;
                    } else {
                      if (((e[A] = c), t(e, n, o))) return (e.sizset = !0), e;
                      e.sizset = !1;
                    }
                  }
            };
      ...
      function u(t, e, n, i, r) {
        for (var a, o = [], s = 0, l = t.length, c = null != e; s < l; s++)
          (a = t[s]) && ((n && !n(a, i, r)) || (o.push(a), c && e.push(s)));
        return o;
      }
        ...
        return (
          ...
          q(function (a, o, s, l) {
            var c,
              ...
              v = [],
              m = o.length,
              g = a || h(e || '*', s.nodeType ? [s] : s, []),
              y = !t || (!a && e) ? g : u(g, f, t, s, l),
              b = n ? (r || (a ? t : m || i) ? [] : o) : y;
            if ((n && n(y, b, s, l), i)) for (c = u(b, v), i(c, [], s, l), d = c.length; d--; ) (p = c[d]) && (b[v[d]] = !(y[v[d]] = p));
            if (a) {
              if (r || t) {
                if (r) {
                ...
                for (d = b.length; d--; ) (p = b[d]) && (c = r ? F.call(a, p) : f[d]) > -1 && (a[c] = !(o[c] = p));
              }
            } else (b = u(b === o ? b.splice(m, b.length) : b)), r ? r(null, o, b, l) : M.apply(o, b);
          })
        );
      }
      function p(t) {
        for (
          ...
          if ((n = b.relative[t[s].type])) h = [l(c(h), n)];
          else {
            if (((n = b.filter[t[s].type].apply(null, t[s].matches)), n[A])) {
        ...
        var i = e.length > 0,
          ...
          a = function (o, s, l, c, d) {
            var p,
              ...
              x = null != d,
              k = S,
              w = o || (r && b.find.TAG('*', (d && s.parentNode) || s)),
              C = (D += null == k ? 1 : Math.E);
            for (x && ((S = s !== N && s), (g = a.el)); null != (p = w[y]); y++) {
              if (r && p) {
                for (f = 0; (h = t[f]); f++)
                  if (h(p, s, l)) {
                    c.push(p);
              ...
              i && ((p = !h && p) && m--, o && _.push(p));
            }
            if (((m += y), i && y !== m)) {
              for (f = 0; (h = e[f]); f++) h(_, v, s, l);
              if (o) {
                if (m > 0) for (; y--; ) !_[y] && !v[y] && (v[y] = I.call(c));
                v = u(v);
              }
              M.apply(c, v), x && !o && v.length > 0 && m + e.length > 1 && n.uniqueSort(c);
            }
            return x && ((D = C), (S = k)), _;
          };
        return (a.el = 0), i ? q(a) : a;
      }
      function h(t, e, i) {
      ...
      function v(t, e, n, i, r) {
        ...
        if (!i && 1 === d.length) {
          ...
          for (a = ot.POS.test(t) ? -1 : o.length - 1; a >= 0 && ((l = o[a]), !b.relative[(c = l.type)]); a--)
            if ((u = b.find[c]) && (i = u(l.matches[0].replace(at, ''), (nt.test(o[0].type) && e.parentNode) || e, r))) {
              if ((o.splice(a, 1), !(t = i.length && o.join('')))) return M.apply(n, P.call(i, 0)), n;
              break;
            }
        }
        return w(t, d)(i, e, r, n, nt.test(t)), n;
      }
      function m() {}
      var g,
        y,
        ...
        X = '\\[' + U + '*(' + V + ')' + U + '*(?:([*^$|!~]?=)' + U + '*(?:([\'"])((?:\\\\.|[^\\\\])*?)\\3|(' + W + ')|)|)' + U + '*\\]',
        Y = ':(' + V + ')(?:\\((?:([\'"])((?:\\\\.|[^\\\\])*?)\\2|([^()[\\]]*|(?:(?:' + X + ')|[^:]|\\\\.)*|.*))\\)|)',
        J = ':(even|odd|eq|gt|lt|nth|first|last)(?:\\(' + U + '*((?:-\\d)?\\d*)' + U + '*\\)|)(?=[^-]|$)',
        K = new RegExp('^' + U + '+|((?:^|[^\\\\])(?:\\\\.)*)' + U + '+$', 'g'),
        G = new RegExp('^' + U + '*,' + U + '*'),
        Z = new RegExp('^' + U + '*([\\x20\\t\\r\\n\\f>+~])' + U + '*'),
        tt = new RegExp(Y),
        ...
        pt = st(function (t) {
          (t.id = A + 0), (t.innerHTML = "<a name='" + A + "'></a><div name='" + A + "'></div>"), O.insertBefore(t, O.firstChild);
          var e = N.getElementsByName && N.getElementsByName(A).length === 2 + N.getElementsByName(A + 0).length;
          return (y = !N.getElementById(A)), O.removeChild(t), e;
        });
      try {
      ...
      (n.matches = function (t, e) {
        ...
        (b = n.selectors =
          {
            ...
            find: {
              ID: y
                ...
                : function (t, e, n) {
                    if (typeof e.getElementById !== E && !n) {
                      var i = e.getElementById(t);
                      return i
                        ? i.id === t || (typeof i.getAttributeNode !== E && i.getAttributeNode('id').value === t)
                          ? [i]
                          : void 0
                        : [];
                    }
              ...
              NAME:
                pt &&
                function (t, e) {
                  if (typeof e.getElementsByName !== E) return e.getElementsByName(name);
                },
              CLASS:
                dt &&
                function (t, e, n) {
                  if (typeof e.getElementsByClassName !== E && !n) return e.getElementsByClassName(t);
                },
            },
            relative: {
              '>': {
            ...
            filter: {
                  ...
                  return null == o
                    ...
                    : !e ||
                        ...
                        '=' === e
                          ...
                          ? i && o.indexOf(i) > -1
                          : '$=' === e
                          ? i && o.substr(o.length - i.length) === i
                          : '~=' === e
                          ? (' ' + o + ' ').indexOf(i) > -1
                          : '|=' === e && (o === i || o.substr(0, i.length + 1) === i + '-'));
                };
              },
                ...
                return 'nth' === t
                  ? function (t) {
                      var e,
                        ...
                        a = t.parentNode;
                      if (1 === n && 0 === i) return !0;
                      if (a) for (r = 0, e = a.firstChild; e && (1 !== e.nodeType || (r++, t !== e)); e = e.nextSibling);
              ...
              PSEUDO: function (t, e) {
                var i,
                  r = b.pseudos[t] || b.setFilters[t.toLowerCase()] || n.error('unsupported pseudo: ' + t);
                return r[A]
                  ? r(e)
                  : r.length > 1
                  ? ((i = [t, t, '', e]),
                    b.setFilters.hasOwnProperty(t.toLowerCase())
                      ? q(function (t, n) {
                          for (var i, a = r(t, e), o = a.length; o--; ) (i = F.call(t, a[o])), (t[i] = !(n[i] = a[o]));
                        })
                      : function (t) {
                          return r(t, 0, i);
                        })
        ...
        (C = O.compareDocumentPosition
          ...
          : function (t, e) {
              ...
              for (var u = 0; u < n && u < i; u++) if (r[u] !== a[u]) return o(r[u], a[u]);
        ...
        (w = n.compile =
          function (t, e) {
            var n,
              ...
              a = z[A][t + ' '];
            if (!a) {
              for (e || (e = s(t)), n = e.length; n--; ) (a = p(e[n])), a[A] ? i.push(a) : r.push(a);
              a = z(t, f(r, i));
            }
            return a;
          }),
            ...
            st(function (t) {
              (t.innerHTML = "<select><option selected=''></option></select>"),
                t.querySelectorAll('[selected]').length ||
                  a.push('\\[' + U + '*(?:checked|disabled|ismap|multiple|readonly|selected|value)'),
              ...
              (v = function (t, n, r, o, l) {
                if (!o && !l && !a.test(t)) {
                  ...
                  if (h)
                    try {
                      return M.apply(r, P.call(f.querySelectorAll(h), 0)), r;
                    } catch (t) {
                    } finally {
              ...
              l &&
                (st(function (e) {
                  t = l.call(e, 'div');
                  try {
                    l.call(e, "[test!='']:sizzle"), o.push('!=', Y);
                  } catch (t) {}
                }),
                (o = new RegExp(o.join('|'))),
                (n.matchesSelector = function (e, i) {
                  if (((i = i.replace(r, "='$1']")), !x(e) && !o.test(i) && !a.test(i)))
                    try {
                      var s = l.call(e, i);
  ...
  Q.fn.extend({
    find: function (t) {
      ...
      for (o = this.pushStack('', 'find', t), e = 0, n = this.length; e < n; e++)
        if (((i = o.length), Q.find(t, this[e], o), e > 0))
    ...
    closest: function (t, e) {
      ...
      return (a = a.length > 1 ? Q.unique(a) : a), this.pushStack(a, 'closest', t);
    },
    index: function (t) {
      return t
        ? 'string' == typeof t
  ...
  (Zt.optgroup = Zt.option),
        ...
        return Q.access(
          ...
          function (t) {
            ...
            if (
              'string' == typeof t &&
              !Wt.test(t) &&
              (Q.support.htmlSerialize || !Yt.test(t)) &&
              (Q.support.leadingWhitespace || !Bt.test(t)) &&
              !Zt[(zt.exec(t) || ['', ''])[1].toLowerCase()]
            ) {
              t = t.replace(Rt, '<$1></$2>');
              try {
                for (; i < r; i++) (n = this[i] || {}), 1 === n.nodeType && (Q.cleanData(n.getElementsByTagName('*')), (n.innerHTML = t));
                n = 0;
              } catch (t) {}
            }
      ...
      domManip: function (t, n, i) {
        ...
        if (Q.isFunction(c))
          return this.each(function (r) {
            var a = Q(this);
            (t[0] = c.call(this, r, n ? a.html() : e)), a.domManip(t, n, i);
          });
        if (this[0]) {
          if (((r = Q.buildFragment(t, this, u)), (o = r.fragment), (a = o.firstChild), 1 === o.childNodes.length && (o = a), a))
            for (n = n && Q.nodeName(a, 'tr'), s = r.cacheable || p - 1; l < p; l++)
              i.call(n && Q.nodeName(this[l], 'table') ? d(this[l], 'tbody') : this[l], l === s ? o : Q.clone(o, !0, !0));
          (o = a = null),
            u.length &&
              Q.each(u, function (t, e) {
                e.src
                  ? Q.ajax
                    ? Q.ajax({
                        url: e.src,
    ...
    (Q.buildFragment = function (t, n, i) {
      ...
      return (
        ...
        1 === t.length &&
          ...
          '<' === s.charAt(0) &&
          !Xt.test(s) &&
          (Q.support.checkClone || !Kt.test(s)) &&
          (Q.support.html5Clone || !Yt.test(s)) &&
          ((a = !0), (r = Q.fragments[s]), (o = r !== e)),
        r || ((r = n.createDocumentFragment()), Q.clean(t, n, r, i), a && (Q.fragments[s] = o && r)),
        {
          fragment: r,
          cacheable: a,
        }
    ...
    Q.each(
      ...
      function (t, e) {
        Q.fn[t] = function (n) {
          ...
          for (; r < s; r++) (i = (r > 0 ? this.clone(!0) : this).get()), Q(o[r])[e](i), (a = a.concat(i));
    ...
    Q.extend({
      clone: function (t, e, n) {
        var i, r, a, o;
        if (
          (Q.support.html5Clone || Q.isXMLDoc(t) || !Yt.test('<' + t.nodeName + '>')
            ? (o = t.cloneNode(!0))
            : ((ee.innerHTML = t.outerHTML), ee.removeChild((o = ee.firstChild))),
          !((Q.support.noCloneEvent && Q.support.noCloneChecked) || (1 !== t.nodeType && 11 !== t.nodeType) || Q.isXMLDoc(t)))
        )
          for (f(t, o), i = h(t), r = h(o), a = 0; i[a]; ++a) r[a] && f(i[a], r[a]);
        if (e && (p(t, o), n)) for (i = h(t), r = h(o), a = 0; i[a]; ++a) p(i[a], r[a]);
        return (i = r = null), o;
      },
      clean: function (t, e, n, i) {
        var r,
          ...
          g = e === B && te,
          y = [];
        for ((e && void 0 !== e.createDocumentFragment) || (e = B), r = 0; null != (o = t[r]); r++)
        ...
        if ((d && (o = d = g = null), !Q.support.appendChecked))
          for (r = 0; null != (o = y[r]); r++)
            Q.nodeName(o, 'input') ? v(o) : void 0 !== o.getElementsByTagName && Q.grep(o.getElementsByTagName('input'), v);
        if (n)
          for (
            h = function (t) {
              if (!t.type || Gt.test(t.type)) return i ? i.push(t.parentNode ? t.parentNode.removeChild(t) : t) : n.appendChild(t);
            },
              r = 0;
            null != (o = y[r]);
            r++
          )
            (Q.nodeName(o, 'script') && h(o)) ||
              (n.appendChild(o),
              void 0 !== o.getElementsByTagName &&
                ((m = Q.grep(Q.merge([], o.getElementsByTagName('script')), h)), y.splice.apply(y, [r + 1, 0].concat(m)), (r += m.length)));
        return y;
      },
      cleanData: function (t, e) {
        for (var n, i, r, a, o = 0, s = Q.expando, l = Q.cache, c = Q.support.deleteExpando, u = Q.event.special; null != (r = t[o]); o++)
          if ((e || Q.acceptData(r)) && ((i = r[s]), (n = i && l[i]))) {
            if (n.events) for (a in n.events) u[a] ? Q.event.remove(r, a) : Q.removeEvent(r, a, n.handle);
            l[i] && (delete l[i], c ? delete r[s] : r.removeAttribute ? r.removeAttribute(s) : (r[s] = null), Q.deletedIds.push(i));
          }
      },
    }),
    (function () {
  ...
  Q.fn.extend({
    ...
    Q.extend({
      ...
      style: function (t, n, i, r) {
        if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
          var a,
            ...
            l = Q.camelCase(n),
            c = t.style;
          if (((n = Q.cssProps[l] || (Q.cssProps[l] = m(c, l))), (s = Q.cssHooks[n] || Q.cssHooks[l]), i === e))
            return s && 'get' in s && (a = s.get(t, !1, r)) !== e ? a : c[n];
          if (
            ('string' === (o = typeof i) && (a = pe.exec(i)) && ((i = (a[1] + 1) * a[2] + parseFloat(Q.css(t, n))), (o = 'number')),
            !(
              null == i ||
              ('number' === o && isNaN(i)) ||
              ('number' === o && !Q.cssNumber[l] && (i += 'px'), s && 'set' in s && (i = s.set(t, i, r)) === e)
            ))
          )
            try {
              c[n] = i;
      ...
      css: function (t, n, i, r) {
        ...
        return (
          ...
          i || r !== e ? ((o = parseFloat(a)), i || Q.isNumeric(o) ? o || 0 : a) : a
        );
      },
      swap: function (t, e, n) {
        var i,
    ...
    Q.support.opacity ||
      (Q.cssHooks.opacity = {
        get: function (t, e) {
          return oe.test((e && t.currentStyle ? t.currentStyle.filter : t.style.filter) || '')
        ...
        set: function (t, e) {
          ...
          (n.zoom = 1),
            (e >= 1 && '' === Q.trim(a.replace(ae, '')) && n.removeAttribute && (n.removeAttribute('filter'), i && !i.filter)) ||
              (n.filter = ae.test(a) ? a.replace(ae, r) : a + ' ' + r);
        },
      }),
    Q(function () {
        ...
        (Q.cssHooks[t + e] = {
          expand: function (n) {
            var i,
              ...
              a = {};
            for (i = 0; i < 4; i++) a[t + me[i] + e] = r[i] || r[i - 2] || r[0];
            return a;
          },
        }),
  ...
  try {
    ...
    ($e = B.createElement('a')), ($e.href = ''), ($e = $e.href);
  }
  (Ce = Le.exec($e.toLowerCase()) || []),
    (Q.fn.load = function (t, n, i) {
      ...
      var r,
        ...
        l = t.indexOf(' ');
      return (
        l >= 0 && ((r = t.slice(l, t.length)), (t = t.slice(0, l))),
        Q.isFunction(n) ? ((i = n), (n = e)) : n && 'object' == typeof n && (a = 'POST'),
        Q.ajax({
          url: t,
          type: a,
          dataType: 'html',
          ...
          (o = arguments), s.html(r ? Q('<div>').append(t.replace(Oe, '')).find(r) : t);
        }),
        this
      );
    }),
    ...
    Q.extend({
      ...
      ajaxSetup: function (t, e) {
        return e ? S(t, Q.ajaxSettings) : ((e = t), (t = Q.ajaxSettings)), S(t, e), t;
      },
      ajaxSettings: {
        url: $e,
      ...
      ajax: function (t, n) {
          ...
          2 !== _ &&
            ...
            (t >= 200 && t < 300) || 304 === t
              ? (p.ifModified &&
                ...
                304 === t ? ((w = 'notmodified'), (c = !0)) : ((c = E(p, b)), (w = c.state), (d = c.data), (y = c.error), (c = !y)))
              : ((y = w), (w && !t) || ((w = 'error'), t < 0 && (t = 0))),
            (k.status = t),
            (k.statusText = (n || w) + ''),
            ...
            m.fireWith(f, [k, w]),
            u && (h.trigger('ajaxComplete', [k, p]), --Q.active || Q.event.trigger('ajaxStop')));
        }
        ...
        var r,
          ...
          k = {
            ...
            getResponseHeader: function (t) {
              var n;
              if (2 === _) {
                if (!o) for (o = {}; (n = Te.exec(a)); ) o[n[1].toLowerCase()] = n[2];
                n = o[t.toLowerCase()];
              }
              return n === e ? null : n;
            },
            ...
            abort: function (t) {
              return (t = t || x), s && s.abort(t), i(0, t), this;
            },
          };
        if (
          (v.promise(k),
          ...
          (k.statusCode = function (t) {
            if (t) {
              var e;
              if (_ < 2) for (e in t) g[e] = [g[e], t[e]];
              else (e = t[k.status]), k.always(e);
            }
            return this;
          }),
          ...
          (p.dataTypes = Q.trim(p.dataType || '*')
            ...
            .split(et)),
          null == p.crossDomain &&
            ((c = Le.exec(p.url.toLowerCase())),
            (p.crossDomain = !(
              !c ||
              (c[1] === Ce[1] && c[2] === Ce[2] && (c[3] || ('http:' === c[1] ? 80 : 443)) == (Ce[3] || ('http:' === Ce[1] ? 80 : 443)))
            ))),
        ...
        if (
          ...
          !p.hasContent && (p.data && ((p.url += (Ne.test(p.url) ? '&' : '?') + p.data), delete p.data), (r = p.url), !1 === p.cache))
        ) {
          var w = Q.now(),
        ...
        ((p.data && p.hasContent && !1 !== p.contentType) || n.contentType) && k.setRequestHeader('Content-Type', p.contentType),
          ...
          k.setRequestHeader(
            ...
            p.dataTypes[0] && p.accepts[p.dataTypes[0]]
              ? p.accepts[p.dataTypes[0]] + ('*' !== p.dataTypes[0] ? ', ' + Fe + '; q=0.01' : '')
              : p.accepts['*']
          );
  ...
  Q.ajaxSetup({
    ...
    Q.ajaxPrefilter('json jsonp', function (n, i, r) {
      var a,
        ...
        u = !1 !== n.jsonp,
        d = u && Be.test(c),
        p = u && !d && 'string' == typeof l && !(n.contentType || '').indexOf('application/x-www-form-urlencoded') && Be.test(l);
      if ('jsonp' === n.dataTypes[0] || d || p)
        return (
          (a = n.jsonpCallback = Q.isFunction(n.jsonpCallback) ? n.jsonpCallback() : n.jsonpCallback),
          (o = t[a]),
          d
            ? (n.url = c.replace(Be, '$1' + a))
            : p
            ? (n.data = l.replace(Be, '$1' + a))
            : u && (n.url += (He.test(c) ? '&' : '?') + n.jsonp + '=' + a),
          (n.converters['script json'] = function () {
            return s || Q.error(a + ' was not called'), s[0];
          }),
          (n.dataTypes[0] = 'json'),
          (t[a] = function () {
            s = arguments;
          ...
          r.always(function () {
            (t[a] = o), n[a] && ((n.jsonpCallback = i.jsonpCallback), qe.push(a)), s && Q.isFunction(o) && o(s[0]), (s = o = e);
          }),
          'script'
        );
    }),
    ...
    Q.ajaxTransport('script', function (t) {
      if (t.crossDomain) {
        var n,
          i = B.head || B.getElementsByTagName('head')[0] || B.documentElement;
        return {
          send: function (r, a) {
            (n = B.createElement('script')),
              ...
              (n.onload = n.onreadystatechange =
                function (t, r) {
                  (r || !n.readyState || /loaded|complete/.test(n.readyState)) &&
                    ((n.onload = n.onreadystatechange = null), i && n.parentNode && i.removeChild(n), (n = e), r || a(200, 'success'));
                }),
            ...
            send: function (r, a) {
              ...
              l.send((n.hasContent && n.data) || null),
                (i = function (t, r) {
                  ...
                  try {
                    if (i && (r || 4 === l.readyState))
                      if (((i = e), o && ((l.onreadystatechange = Q.noop), Ue && delete ze[o]), r)) 4 !== l.readyState && l.abort();
                      else {
                        (s = l.status), (u = l.getAllResponseHeaders()), (d = {}), (p = l.responseXML) && p.documentElement && (d.xml = p);
                        try {
                ...
                n.async
                  ? 4 === l.readyState
                    ? setTimeout(i, 0)
                    : ((o = ++Ve), Ue && (ze || ((ze = {}), Q(t).unload(Ue)), (ze[o] = i)), (l.onreadystatechange = i))
                  : i();
            },
            abort: function () {
              i && i(0, 1);
      ...
      '*': [
        function (t, e) {
          var n,
            ...
            c = 20;
          if (a) {
            if (((n = +a[2]), 'px' !== (i = a[3] || (Q.cssNumber[t] ? '' : 'px')) && s)) {
              s = Q.css(r.elem, t, !0) || n || 1;
              do {
                (l = l || '.5'), (s /= l), Q.style(r.elem, t, s + i);
  ...
  (Q.Animation = Q.extend(D, {
    tweener: function (t, e) {
      ...
      for (var n, i = 0, r = t.length; i < r; i++) (n = t[i]), (Qe[n] = Qe[n] || []), Qe[n].unshift(e);
    },
    ...
    Q.each(['toggle', 'show', 'hide'], function (t, e) {
      ...
      Q.fn[e] = function (i, r, a) {
        return null == i || 'boolean' == typeof i || (!t && Q.isFunction(i) && Q.isFunction(r))
          ? n.apply(this, arguments)
          : this.animate(P(e, !0), i, r, a);
      };
    }),
    Q.fn.extend({
      ...
      stop: function (t, n, i) {
        ...
        return (
          ...
          this.each(function () {
            ...
            else for (n in o) o[n] && o[n].stop && Ke.test(n) && r(o[n]);
            for (n = a.length; n--; )
  ...
  (Q.fn.offset = function (t) {
    ...
    if (d)
      return (i = d.body) === u
        ? Q.offset.bodyOffset(u)
        : ((n = d.documentElement),
          Q.contains(n, u)
            ? (void 0 !== u.getBoundingClientRect && (c = u.getBoundingClientRect()),
              (r = F(d)),
    ...
    (Q.offset = {
      ...
      setOffset: function (t, e, n) {
        ...
        var r,
          ...
          d = {},
          p = {};
        u ? ((p = o.position()), (r = p.top), (a = p.left)) : ((r = parseFloat(l) || 0), (a = parseFloat(c) || 0)),
    ...
    Q.fn.extend({
      ...
      offsetParent: function () {
        return this.map(function () {
          for (var t = this.offsetParent || B.body; t && !Ze.test(t.nodeName) && 'static' === Q.css(t, 'position'); ) t = t.offsetParent;
          return t || B.body;
        });
      },
    }),
              ...
              return Q.access(
                ...
                function (n, i, r) {
                  ...
                  return Q.isWindow(n)
                    ...
                    : 9 === n.nodeType
                    ? ((a = n.documentElement),
                      Math.max(n.body['scroll' + t], a['scroll' + t], n.body['offset' + t], a['offset' + t], a['client' + t]))
                    : r === e
                    ? Q.css(n, i, r, s)
                    : Q.style(n, i, r, s);
                },
  ...
  define('commonFunc', ['require', 'exports', 'module'], function (t, e, n) {
    ...
    var i = {
      ...
      accAdd: function (t, e) {
        ...
        if (((r = Math.abs(n - i)), (a = Math.pow(10, Math.max(n, i))), r > 0)) {
          var o = Math.pow(10, r);
          n > i
            ? ((t = Number(t.toString().replace('.', ''))), (e = Number(e.toString().replace('.', '')) * o))
            : ((t = Number(t.toString().replace('.', '')) * o), (e = Number(e.toString().replace('.', ''))));
      ...
      accDiv: function (t, e) {
        ...
        return (n = Number(t.toString().replace('.', ''))), (i = Number(e.toString().replace('.', ''))), (n / i) * Math.pow(10, a - r);
      },
      timeCalc: function (t) {
      ...
      digitsTranform: function (t, e, n, i, r) {
        var a;
        return null === (a = null === t ? null : isNaN(t) ? null : Number(t))
          ? (a = r ? '--' : a)
          : 0 === a
          ? (a = i ? a + '%' : a)
          : ((a = n ? (100 * a).toFixed(e) : a.toFixed(e)), (a = +a), (a = i ? a + '%' : a));
      },
    };
    n.exports = i;
  }),
    ...
    var i = t('commonFunc'),
      ...
      a = {
        jsonp: function (t) {
          var e = {};
          (e.url = t.url),
            t.data ? ((e.data = t.data), (e.data.isajax = 1), (e.data.datatype = 'jsonp')) : (e.data = r.data),
            (e.type = r.type),
  ...
  function () {
      ...
      w.forEach =
        function (t, e, i) {
          ...
          if (d && t.forEach === d) t.forEach(e, i);
            ...
            for (var r = 0, a = t.length; a > r; r++) if (e.call(i, t[r], r, t) === n) return;
          } else for (var o = w.keys(t), r = 0, a = o.length; a > r; r++) if (e.call(i, t[o[r]], o[r], t) === n) return;
          return t;
        });
    ...
    (w.reduce =
      ...
      w.inject =
        function (t, e, n, i) {
          ...
          if ((null == t && (t = []), f && t.reduce === f)) return i && (e = w.bind(e, i)), r ? t.reduce(e, n) : t.reduce(e);
          if (
            (C(t, function (t, a, o) {
      ...
      (w.reduceRight = w.foldr =
        function (t, e, n, i) {
          ...
          if (
            (C(t, function (s, l, c) {
              (l = o ? o[--a] : --a), r ? (n = e.call(i, n, t[l], l, c)) : ((n = t[l]), (r = !0));
            }),
            !r)
          )
            throw new TypeError($);
    ...
    (w.contains = w.include =
      ...
      (w.sample = function (t, e, n) {
        return null == e || n
          ? (t.length !== +t.length && (t = w.values(t)), t[w.random(t.length - 1)])
    ...
    (w.flatten = function (t, e) {
      ...
      (w.uniq = w.unique =
        function (t, e, n, i) {
          ...
          return (
            C(r, function (n, i) {
              (e ? i && o[o.length - 1] === n : w.contains(o, n)) || (o.push(n), a.push(t[i]));
            }),
            a
          );
        }),
      ...
      (w.zip = function () {
        for (var t = w.max(w.pluck(arguments, 'length').concat(0)), e = new Array(t), n = 0; t > n; n++) e[n] = w.pluck(arguments, '' + n);
        return e;
      }),
    ...
    (w.bind = function (t, e) {
      ...
      (w.partial = function (t) {
        var e = s.call(arguments, 1);
        return function () {
          for (var n = 0, i = e.slice(), r = 0, a = i.length; a > r; r++) i[r] === w && (i[r] = arguments[n++]);
      ...
      (w.throttle = function (t, e, n) {
        ...
        n || (n = {});
        var l = function () {
          (s = !1 === n.leading ? 0 : w.now()), (o = null), (a = t.apply(i, r)), (i = r = null);
        };
        return function () {
          var c = w.now();
          s || !1 !== n.leading || (s = c);
          ...
          return (
            ...
            (r = arguments),
            0 >= u
              ? (clearTimeout(o), (o = null), (s = c), (a = t.apply(i, r)), (i = r = null))
              : o || !1 === n.trailing || (o = setTimeout(l, u)),
            a
          );
        };
      }),
      (w.debounce = function (t, e, n) {
        var i,
          ...
          l = function () {
            var c = w.now() - o;
            e > c ? (i = setTimeout(l, e - c)) : ((i = null), n || ((s = t.apply(a, r)), (a = r = null)));
          };
        return function () {
          (a = this), (r = arguments), (o = w.now());
          var c = n && !i;
          return i || (i = setTimeout(l, e)), c && ((s = t.apply(a, r)), (a = r = null)), s;
        };
      }),
      (w.once = function (t) {
        var e,
      ...
      (w.values = function (t) {
        for (var e = w.keys(t), n = e.length, i = new Array(n), r = 0; n > r; r++) i[r] = t[e[r]];
        return i;
      }),
      (w.pairs = function (t) {
        for (var e = w.keys(t), n = e.length, i = new Array(n), r = 0; n > r; r++) i[r] = [e[r], t[e[r]]];
        return i;
      }),
      (w.invert = function (t) {
        for (var e = {}, n = w.keys(t), i = 0, r = n.length; r > i; i++) e[t[n[i]]] = n[i];
        return e;
      }),
    ...
    var N = function (t, e, n, i) {
      ...
      for (var a = n.length; a--; ) if (n[a] == t) return i[a] == e;
      var o = t.constructor,
        s = e.constructor;
      ...
      var l = 0,
        u = !0;
      if ('[object Array]' == r) {
        if (((l = t.length), (u = l == e.length))) for (; l-- && (u = N(t[l], e[l], n, i)); );
      } else {
        for (var d in t) if (w.has(t, d) && (l++, !(u = w.has(e, d) && N(t[d], e[d], n, i)))) break;
        if (u) {
          for (d in e) if (w.has(e, d) && !l--) break;
          u = !l;
        }
      }
      ...
      (w.mixin = function (t) {
        C(w.functions(t), function (e) {
          ...
          w.prototype[e] = function () {
            var t = [this._wrapped];
            return o.apply(t, arguments), F.call(this, n.apply(w, t));
          };
        });
      });
    var L = 0;
    ...
    (w.template = function (t, e, n) {
      ...
      t.replace(r, function (e, n, i, r, s) {
        return (
          (o += t.slice(a, s).replace(P, function (t) {
            return '\\' + M[t];
          })),
  ...
  (function (t, e) {
    ...
    var s = (e.Events = {
        ...
        once: function (t, e, i) {
          ...
          var r = this,
            a = n.once(function () {
              r.off(t, a), e.apply(this, arguments);
            });
          return (a._callback = e), this.on(t, a, i);
        },
        off: function (t, e, i) {
          var r, a, o, s, l, u, d, p;
          if (!this._events || !c(this, 'off', t, [e, i])) return this;
          if (!t && !e && !i) return (this._events = void 0), this;
          for (s = t ? [t] : n.keys(this._events), l = 0, u = s.length; l < u; l++)
            if (((t = s[l]), (o = this._events[t]))) {
              if (((this._events[t] = r = []), e || i))
                for (d = 0, p = o.length; d < p; d++)
                  (a = o[d]), ((e && e !== a.callback && e !== a.callback._callback) || (i && i !== a.context)) && r.push(a);
        ...
        stopListening: function (t, e, i) {
          ...
          for (var o in r) (t = r[o]), t.off(e, i, this), (a || n.isEmpty(t._events)) && delete this._listeningTo[o];
          return this;
        },
      }),
      l = /\s+/,
      c = function (t, e, n, i) {
        ...
        if (l.test(n)) {
          for (var a = n.split(l), o = 0, s = a.length; o < s; o++) t[e].apply(t, [a[o]].concat(i));
          return !1;
        }
        return !0;
      },
      u = function (t, e) {
        ...
        switch (e.length) {
          case 0:
            ...
            return;
          case 1:
            for (; ++i < r; ) (n = t[i]).callback.call(n.ctx, a);
            return;
          case 2:
            for (; ++i < r; ) (n = t[i]).callback.call(n.ctx, a, o);
            return;
          case 3:
            for (; ++i < r; ) (n = t[i]).callback.call(n.ctx, a, o, s);
            return;
          default:
    ...
    n.extend(p.prototype, s, {
      ...
      set: function (t, e, i) {
        ...
        if (('object' == typeof t ? ((a = t), (i = e)) : ((a = {})[t] = e), i || (i = {}), !this._validate(a, i))) return !1;
        (o = i.unset),
          (l = i.silent),
          (s = []),
          (c = this._changing),
        ...
        if (!l) {
          ...
          for (var p = 0, f = s.length; p < f; p++) this.trigger('change:' + s[p], this, d[s[p]], i);
        }
        if (c) return this;
      ...
      changedAttributes: function (t) {
        ...
        for (var a in t) n.isEqual(r[a], (e = t[a])) || ((i || (i = {}))[a] = e);
        return i;
      },
      previous: function (t) {
      ...
      save: function (t, e, i) {
        ...
        return (
          (i.success = function (t) {
            l.attributes = s;
            var e = l.parse(t, i);
            if ((i.wait && (e = n.extend(r || {}, e)), n.isObject(e) && !l.set(e, i))) return !1;
    ...
    n.extend(h.prototype, s, {
      ...
      set: function (t, e) {
        ...
        var r,
          ...
          w = !(h || !_ || !k) && [];
        for (r = 0, a = t.length; r < a; r++) {
          if (((l = t[r] || {}), (o = l instanceof p ? (s = l) : l[f.prototype.idAttribute || 'id']), (c = this.get(o))))
            k && (b[c.cid] = !0),
              x && ((l = l === s ? s.attributes : l), e.parse && (l = c.parse(l, e)), c.set(l, e), h && !u && c.hasChanged(m) && (u = !0)),
              (t[r] = c);
          else if (_) {
            if (!(s = t[r] = this._prepareModel(l, e))) continue;
            g.push(s), this._addReference(s, e);
          }
          (s = c || s), !w || (!s.isNew() && b[s.id]) || w.push(s), (b[s.id] = !0);
        }
        if (k) {
          for (r = 0, a = this.length; r < a; ++r) b[(s = this.models[r]).cid] || y.push(s);
          y.length && this.remove(y, e);
        }
        if (g.length || (w && w.length))
          if ((h && (u = !0), (this.length += g.length), null != d))
            for (r = 0, a = g.length; r < a; r++) this.models.splice(d + r, 0, g[r]);
          else {
            w && (this.models.length = 0);
            var C = w || g;
            for (r = 0, a = C.length; r < a; r++) this.models.push(C[r]);
          }
        if (
          (u &&
            this.sort({
          ...
          for (r = 0, a = g.length; r < a; r++) (s = g[r]).trigger('add', s, this, e);
    ...
    n.extend(b.prototype, s, {
        ...
        for (var e in t) {
          ...
          if ((n.isFunction(i) || (i = this[t[e]]), i)) {
            var r = e.match(_),
              a = r[1],
              o = r[2];
            (i = n.bind(i, this)), (a += '.delegateEvents' + this.cid), '' === o ? this.$el.on(a, i) : this.$el.on(a, o, i);
          }
        }
        return this;
      },
      ...
      (e.sync = function (t, i, r) {
        ...
        if (
          ...
          (o.type = 'POST'), r.emulateJSON && (o.data._method = a);
          var s = r.beforeSend;
          r.beforeSend = function (t) {
            if ((t.setRequestHeader('X-HTTP-Method-Override', a), s)) return s.apply(this, arguments);
          };
        }
      ...
      route: function (t, i, r) {
        ...
        return (
          e.history.route(t, function (n) {
            ...
            a.execute(r, o), a.trigger.apply(a, ['route:' + i].concat(o)), a.trigger('route', i, o), e.history.trigger('route', a, i, o);
          }),
          this
        );
      },
    ...
    (A.started = !1),
      n.extend(A.prototype, s, {
        ...
        start: function (t) {
          ...
          if (((this.root = ('/' + this.root + '/').replace(N, '/')), a && this._wantsHashChange)) {
          ...
          this._hasPushState
            ...
            : this._wantsHashChange && 'onhashchange' in window && !a
          ...
          if (this._wantsHashChange && this._wantsPushState) {
            ...
            this._hasPushState &&
              this.atRoot() &&
              s.hash &&
              ((this.fragment = this.getHash().replace(j, '')), this.history.replaceState({}, document.title, this.root + this.fragment));
          }
    ...
    var I = function (t, e) {
      ...
      return (a.prototype = r.prototype), (i.prototype = new a()), t && n.extend(i.prototype, t), (i.__super__ = r.prototype), i;
    };
    ...
    return {
      get: function (t) {
        for (var e = t + '=', n = e.length, i = document.cookie.length, r = 0, a = 0; r < i; ) {
          if (((a = r + n), document.cookie.substring(r, a) === e)) {
          ...
          if (0 === (r = document.cookie.indexOf(' ', r) + 1)) break;
        }
        return !1;
      },
      set: function (t, e, n) {
  ...
  define('../models/common/ajaxbase', ['module', 'backbone'], function (t, e) {
    return e.Model.extend({
      ...
      sortData: function (t, e, n, i) {
        var r = this;
        return (n = n.sort(r.sortTableFun(t, e))), r.getPageData(i, n);
      },
      ...
      getPageData: function (t, e, n) {
        for (var i = 1, r = [], a = 0; a < n.length; a++) {
          if ((t === Math.ceil(i / e) && r.push(n[a]), t < Math.ceil(i / e))) {
            i++;
            break;
          }
          i++;
      ...
      searchData: function (t, e, n) {
        var i = [];
        for (var r in n) ('all' !== t && -1 === ('' + n[r][e]).indexOf(t)) || i.push(n[r]);
        return i;
      },
    });
  }),
      ...
      search: function (t, e) {
        var n = this,
          ...
          a = function (t) {
            if (t.errorcode) return void e(t);
            var r = {};
            (r[i] = t), n.set(r), e(t.result);
          };
        if (this.has(i)) return void a(this.get(i));
        this._run(t, r, a);
      },
    }))();
  }),
  ...
  define('text', ['module'], function (t) {
    ...
    function n(t, n, i, r) {
      if (n === r) return !0;
      if (t === i) {
        if ('http' === t) return e(n, '80') === e(r, '80');
        if ('https' === t) return e(n, '443') === e(r, '443');
      }
      return !1;
    }
    var i,
    ...
    return (
      (i = {
        ...
        parseName: function (t) {
          ...
          return (
            -1 !== a && (!o || a > 1) ? ((e = t.substring(0, a)), (n = t.substring(a + 1))) : (e = t),
            (i = n || e),
            (a = i.indexOf('!')),
            -1 !== a && ((r = 'strip' === i.substring(a + 1)), (i = i.substring(0, a)), n ? (n = i) : (e = i)),
            {
              moduleName: e,
              ext: n,
              strip: r,
        ...
        finishLoad: function (t, e, n, r) {
          (n = e ? i.strip(n) : n), m.isBuild && (v[t] = n), r(n);
        },
      ...
      (!m.env &&
        ...
        ? (i.get = function (t, e, n, r) {
            ...
            m.onXhr && m.onXhr(o, t),
              (o.onreadystatechange = function (i) {
                ...
                4 === o.readyState &&
                  ((r = o.status || 0),
                  r > 399 && r < 600 ? ((a = new Error(t + ' HTTP status: ' + r)), (a.xhr = o), n && n(a)) : e(o.responseText),
        ...
        ? (i.get = function (t, e) {
            var n,
              ...
              o = new java.io.BufferedReader(new java.io.InputStreamReader(new java.io.FileInputStream(r), 'utf-8')),
              s = '';
            try {
              for (
        ...
        : ('xpconnect' === m.env || (!m.env && 'undefined' != typeof Components && Components.classes && Components.interfaces)) &&
          ...
          (i.get = function (t, e) {
            var n,
              ...
              r,
              l = {};
            s && (t = t.replace(/\//g, '\\')), (r = new FileUtils.File(t));
            try {
  ...
  define('dialog', ['backbone', 'underscore', 'text!templates/lib/dialog.html'], function (t, e, n) {
    return t.View.extend({
      ...
      setWidth: function (t) {
        ...
        return (
          this.$el.find('.plugin-dialog').css({
            width: t,
            'margin-left': e,
          }),
          this
  ...
  define(
    ...
    function (t, e, n, i, r, a, o, s, l, c, u) {
      return new (t.View.extend({
        el: '#header',
        changeImageDom: [],
        pollingRemindDom: [],
  ...
  define(
    '../components/strategy-lib/strategy-index/list/strategy-list',
    ['require', 'exports', 'module', 'VueAjax', 'VueConfig', 'dialog', 'commonFunc'],
    function (t, e, n) {
      var i = t('VueAjax'),
        r = t('VueConfig'),
        a = (t('dialog'), t('commonFunc'));
      n.exports = Vue.extend({
        template:
          '<div class="strategybox-list-item f-cb" :class="choosedClass" @click.stop="strategyClick"><b class="pic file"></b><span class="text" :title="algoname">{{algoname}}</span></div>',
        props: {
          algoname: String,
          ...
          strategyClick: function () {
            ...
            $('#menu_strategy').remove(),
              ...
              i.jsonp({
                ...
                success: function (e) {
                  (t.$store.state.backtestInfo = e), (t.$store.state.backtestId = t.strategyId);
                },
                ...
                error: function (t) {
                  a.warningTip('网络异常，请稍后再试'), a.editor.getSession().setValue('');
                },
              });
          },
        },
          ...
          if (this.menuShow && this.classStrategyChoosed) {
            ...
            i.jsonp({
              ...
              resulterror: function (t) {
                a.warningTip(t.errormsg), a.editor.getSession().setValue('');
              },
              error: function (t) {
                a.warningTip('网络异常，请稍后再试'), a.editor.getSession().setValue('');
              },
  ...
  define(
    ...
    function (t, e, n) {
      ...
      n.exports = Vue.extend({
        ...
        methods: {
          shrinkList: function () {
            $('#mf_stgy').css('margin-left', '-13%'), (this.$store.state.indexShow = !0);
            var t = this;
            setTimeout(function () {
...
!(function () {
  ...
  function a(t, e) {
    ...
    for (u = t.parentNode; u.tagName && !n.ROOT_TAG.test(u.tagName); )
      (u.scrollTop || u.scrollLeft) &&
        (n.OP_SCROLL.test(p(u)) || (y && 'visible' === u.style.overflow) || ((o -= u.scrollLeft), (a -= u.scrollTop))),
        (u = u.parentNode);
    if (!i) {
      var f = s(r);
      (o -= f.left), (a -= f.top);
  ...
  function u(n, r) {
    ...
    if ($dp) {
      ...
      for (s in h) '$' != s.substring(0, 1) && void 0 === o[s] && (o[s] = h[s]);
      if (r) {
        if (
          !(function () {
          ...
          return void ($ =
            ...
            setInterval(function () {
              'complete' == v[x].readyState && clearInterval($), u(null, !0);
            }, 50));
        if (0 != $dp.status) return;
        ($dp.status = 1), (o.el = _), f(o, !0);
      } else if (o.eCont) (o.eCont = $dp.$(o.eCont)), (o.el = _), (o.autoPickDate = !0), (o.qsEnabled = !1), f(o);
      else {
        if (h.$preLoad && 2 != $dp.status) return;
        var l = a();
        if (
          ((b.event === l || l) && ((o.srcEl = l.srcElement || l.target), (l.cancelBubble = !0)),
  ...
  function f(t, e) {
    function n(t, e) {
      ...
      var o,
        s = (h.$langList, h.$skinList);
      try {
        o = t.lastChild.contentWindow[x];
      } catch (e) {
        (a = !0), t.removeChild(t.lastChild);
        ...
        return (
          ...
          void setTimeout(function () {
            (o = t.lastChild.contentWindow[x]), n();
          }, 97)
        );
      }
      n();
    ...
    function i(t) {
      ...
      if (i != _) {
        ...
        var l = a(i),
          ...
          h = $dp.dd.offsetWidth;
        if ((isNaN(n) && (n = 0), c.topM + l.bottom + f > u.height && c.topM + l.top - f > 0)) n += d.top + c.topM + l.top - f - 2;
        else {
  ...
  var v,
    ...
    C = navigator.appName;
  if (
    ('Microsoft Internet Explorer' == C ? (m = !0) : 'Opera' == C ? (y = !0) : (g = !0),
    h.$dpPath ||
      (function () {
        for (
          var t, e, n = b[x][w]('script'), i = 0;
          i < n.length &&
    ...
    h.$wdate &&
      (function (t, e, n) {
        ...
        i && ((r.href = t), (r.rel = 'stylesheet'), (r.type = 'text/css'), e && (r.title = e), n && (r.charset = n), i.appendChild(r));
      })('//s.thsi.cn/js/quant/lib/wdatepicker/skin/WdatePicker.css'),
    (v = b),
    h.$crossFrame)
  )
    try {
      for (; v.parent != v && 0 == v.parent[x][w]('frameset').length; ) v = v.parent;
    } catch (t) {}
  v.$dp ||
    (v.$dp = {
      ff: g,
    ...
    b[x].docMD || (e(b[x], 'onmousedown', l, !0), (b[x].docMD = !0)),
    v[x].docMD || (e(v[x], 'onmousedown', l, !0), (v[x].docMD = !0)),
  ...
  define(
    '../components/strategy-lib/backreport/backreport',
    ['require', 'exports', 'module', 'VueAjax', 'VueConfig', 'commonFunc', 'wdatepicker', 'datemethod', '../../../lib/datamethod'],
    function (t, e, n) {
      var i = t('VueAjax'),
        r = t('VueConfig'),
        a = t('commonFunc'),
        o = (t('wdatepicker'), t('datemethod')),
        s = t('../../../lib/datamethod');
      n.exports = Vue.extend({
        template:
          '<div @click="hideOption" id="customcode_backrepottbox_chartspanel" class="backrepottbox-chartspanel"><div id="customcode_backrepottbox_toolbar" class="toolbar clearfix"><div class="toolbar-datasection"><input type="text" disabled="disabled" v-model="startdate" id="customcode_backrepottbox_startDate"><span>至</span><input type="text" disabled="disabled" v-model="enddate" id="customcode_backrepottbox_endDate"></div><div class="toolbar-money"><span>￥</span><input type="text" disabled="disabled" v-model="fundBase" id="customcode_backrepottbox_money"></div><div @click.stop="troggleOption" class="toolbar-pattern clearfix"><span id="customcode_backrepottbox_pattern" class="fl" :data-pattern="selectedFrequency.value">{{selectedFrequency.name}}</span><span class="icon icon-down fr mt5"></span><ul v-show="showOption" id="toolbar_pattern_select" class="toolbar-pattern-select"><li @click="selectOption(item.value)" v-for="item in frequency" :data-pattern="item.value" class="toolbar-pattern-option" :class="item.selected ? activeClass : null">{{item.name}}</li></ul></div><div id="link_bkrpt" @click="jumpDetail" v-stat="{act: \'hcxq\'}" data-backreportid="" class="fr mr10 backreport_title_btn link_backreport_result">回测详情 &gt;</div></div><table id="customcode_backrepottbox_data" class="backrepottbox-data"><thead><tr><td>策略收益</td><td>基准收益</td><td>Alpha</td><td>Beta</td><td>Sharpe</td><td>最大回撤</td></tr></thead><tbody id="customcode_backrepottbox_data_tbody"><tr><td>{{performance.yieldData}}</td><td>{{performance.benchmarkYield}}</td><td>{{performance.alpha}}</td><td>{{performance.beta}}</td><td>{{performance.sharp}}</td><td>{{performance.drawdown}}</td></tr></tbody></table><div id="customcode_backrepottbox_charts" class="backrepottbox-charts" style="width: 820px; height: 403px;"><div v-show="showEmpty" :style="profitChartStyle"><p style="text-align:center;margin-top:50px;">点击“运行”进行回测</p></div><div v-show="!showEmpty" id="customcode_backrepottbox_chart1" :style="profitChartStyle"></div><div v-show="!hideRecordChart &amp;&amp; !showEmpty" id="customcode_backrepottbox_chart4" style="width: 100%; height: 50%"></div></div></div>',
        props: {},
        data: function () {
          return {
            fundBase: 1e6,
        ...
        methods: {
          ...
          selectOption: function (t) {
            for (var e in this.frequency)
              this.frequency[e].value === t ? (this.frequency[e].selected = !0) : (this.frequency[e].selected = !1);
          },
  ...
  define(
    '../components/strategy-lib/ace-area/ace-area',
    ['require', 'exports', 'module', 'VueAjax', 'VueConfig', 'commonFunc', 'dialog'],
    function (t, e, n) {
      var i = t('VueAjax'),
        r = t('VueConfig'),
        a = t('commonFunc'),
      ...
      n.exports = Vue.extend({
        ...
        watch: {
          backtestid: function (t) {
            null !== this.backtestinfo && this.backtestinfo.code && (this.restartEditor(this.backtestinfo.code), this.getCopyNum(t));
          },
        },
        methods: {
          strategyCopyClick: function () {
            ...
            c
              .render({
                title: '新建策略',
                content:
                  '<div class="input">                        <input type="text" id="dialog_alert_input" value="">                    </div>                    <div class="warn"></div>',
                okEvent: function () {
                  TA.log(
                    l.isIfind
                      ? {
                  ...
                  if ('' === t) return void a.warningTip('策略名称不能为空');
                  i.jsonp({
                    ...
                    success: function (t) {
                      i.jsonp({
                        ...
                        success: function (e) {
                          if (!t._id) return a.warningTip('新增策略返回数据格式错误'), !1;
                          a.tip('新建策略成功'),
                            (location.href =
                              -1 !== window.location.pathname.indexOf('ifind')
                                ? 'study-ifind.html?strategyid=' + t._id
                                : 'study.html?strategyid=' + t._id);
                        },
                        resulterror: function (t) {
          ...
          restartEditor: function (t) {
            if (a.editor) return void a.editor.getSession().setValue(t || '');
  ...
  define('../components/strategy-lib/log/strategybox', ['require', 'exports', 'module', 'VueAjax', 'VueConfig'], function (t, e, n) {
    ...
    n.exports = Vue.extend({
      template:
        '<div id="zUI_logbox" class="backrepottbox-content zUIpanel" style="overflow-y:hidden">\x3c!-- <div id="customcode_backreporttbox_errordata" class="log-content"><div v-for="row in logdata.logs"><p class="line1"><span class="date">{{ row.time }}</span><span> - </span><span class="type type-info">{{ row.type }}</span></p><pre class="line2 message" v-html="row.value"></pre></div></div> --\x3e<iframe :src="iframeUrl" frameborder="0" width="100%" height="100%"></iframe></div>',
      ...
      methods: {
        onScroll: function () {
          ...
          $('#zUI_logbox').scroll(function () {
            ...
            n + e.scrollTop() + 10 >= i && t.logFlag && t.pagecount >= t.logPage && ((t.logFlag = !1), t.requestLogData());
          });
        },
        requestLogData: function () {
          ...
          i.jsonp({
            ...
            success: function (e) {
              var n = e.total,
                i = e.list;
              if (((t.total = n), (t.logPage = t.logPage + 1), (t.logFlag = !0), i)) {
                for (var r = i.length, a = 0; a < r; a++) ('INFO' !== i[a].type && 'WARN' !== i[a].type) || t.logdata.logs.push(i[a]);
  ...
  define('../components/strategy-lib/log/sumi-trade', ['require', 'exports', 'module', 'VueAjax', 'VueConfig'], function (t, e, n) {
    ...
    n.exports = Vue.extend({
      template:
        '<div id="zUI_wrongbox" class="backrepottbox-content zUIpanel" style="overflow-y:hidden">\x3c!-- <div id="customcode_backreporttbox_errordata" class="log-content"><div v-for="row in logdata.errorLogs"><p class="line1"><span class="date">{{ row.time }}</span><span> - </span><span class="type type-error">{{ row.type }}</span></p><pre class="line2 message" v-html="row.value"></pre></div></div> --\x3e<iframe :src="iframeUrl" frameborder="0" width="100%" height="100%"></iframe></div>',
      props: ['logdata'],
      computed: {
        iframeUrl: function () {
  ...
  define('../components/strategy-lib/log/nopage', ['require', 'exports', 'module', 'VueAjax', 'VueConfig'], function (t, e, n) {
    ...
    n.exports = Vue.extend({
      template:
        '<div id="zUI_logbox" class="backrepottbox-content zUIpanel"><div style="    width: 150px;text-align: center;position: absolute;left: 50%;top: 50%;margin-left: -75px;margin-top: -75px;font-size:16px;"><img src="//i.thsi.cn/images/quant/201706161111/empty.png" style="width:100%;"><p>暂无内容</p></div></div>',
      props: ['logdata', 'pagecount'],
      data: function () {
        return {
          logPage: 2,
  ...
  define(
    '../components/strategy-lib/log/log',
    ['require', 'exports', 'module', 'VueAjax', 'VueConfig', './strategybox', './sumi-trade', './nopage', 'commonFunc'],
    function (t, e, n) {
      var i = t('VueAjax'),
        r = t('VueConfig'),
        a = t('./strategybox'),
      ...
      n.exports = Vue.extend({
        ...
        watch: {
          ...
          backtestid: function (t) {
            this.$store.commit('updateresearchresult', {}), this.$store.commit('updateresearchurl', '');
            var e = this;
            return this.$store.state.strategyChoosed.research_id
              ? (i.jsonp({
                  ...
                  success: function (t) {
                    e.$store.commit('updateresearchresult', t), e.$store.commit('updateresearchurl', t.uri);
                  },
                }),
                this.$store.state.strategyChoosed && e.$store.state.researchresult && e.$store.state.researchurl
                  ? void (this.getSelectedIndex = 0)
                  : this.$store.state.strategyChoosed && !e.$store.state.researchresult && this.$store.state.strategyChoosed.simu_algo_id
                  ? void (this.getSelectedIndex = 1)
                  : void (this.getSelectedIndex = 2))
              : ((this.strategyResearchShow = !1), (this.simuShow = !1), void (this.getSelectedIndex = 2));
          },
        },
        computed: {
  ...
  define(
    '../components/strategy-lib/strategy-lib',
    [
      'require',
      'exports',
      'module',
      ...
      'VueConfig',
      '../../views/common/header',
      '../strategy-lib/strategy-index/strategy-index',
      '../strategy-lib/backreport/backreport',
      '../strategy-lib/ace-area/ace-area',
      '../strategy-lib/log/log',
      'commonFunc',
    ],
    function (t, e, n) {
      var i = t('VueAjax'),
        r = t('VueConfig'),
        a = (t('../../views/common/header'), t('../strategy-lib/strategy-index/strategy-index')),
        ...
        beforeMount: function () {
          ...
          (this.outStrategyId = c.getQueryString('strategyid')),
            ...
            $('body').on('mousedown', function (e) {
              'layout_adjust2' === e.target.id &&
                ((t.layoutAdjust2Flag = !0),
            ...
            $('body').on('mousemove', function (e) {
              ...
              if (t.layoutAdjust2Flag)
                if ((t.$children[2].chartResize(), !1 === t.$store.state.indexShow)) {
                  if ((n = parseInt((100 * (e.clientX - 80)) / $('#strategylib_container').width() - 15)) < 30 || n > 53) return;
                  $('#customcode_editorbox').width(n + '%'), $('.backrepottbox').width(79 - n + '%');
                } else {
                  if ((n = parseInt((100 * (e.clientX - 80)) / $('#strategylib_container').width() - 1.5)) < 30 || n > 66.5) return;
                  $('#customcode_editorbox').width(n + '%'), $('.backrepottbox').width(92 - n + '%');
                }
            });
        },
        methods: {
                  ...
                  ? ($.each(a, function (t, e) {
                      if (
                        ($.each(e.data, function (e, n) {
                          return (o = n), (i['' + t + n.backtest_id].menuOpen = !0), (i['' + t + n.backtest_id].choosed = !0), !1;
                        }),
                        null !== o)
                      )
                        return (e.menuOpen = !0), (e.folderChoosed = !0), !1;
                    }),
                    n && n[0] && ((i['-1' + n[0].algo_id].choosed = !0), (o = n[0])))
                  : ($.each(a, function (t, e) {
                      if (
                        ($.each(e.data, function (e, n) {
                    ...
                    null === o && n && n[0] && ((i['-1' + n[0].algo_id].choosed = !0), (o = n[0]))),
                (t.rootFolderData = n),
                (t.strategyChoosed = o),
                (t.backtestData = i),
                (t.fileFolders = a);
    ...
    n.exports = Vue.extend({
      ...
      computed: {
        pagers: function () {
          ...
          var r = [];
          if (n && !i) for (var a = e - 5, o = a; o < e; o++) r.push(o);
          else if (!n && i) for (var o = 2; o < 7; o++) r.push(o);
          else if (n && i) for (var s = Math.floor(3.5) - 1, o = t - s; o <= t + s; o++) r.push(o);
          else for (var o = 2; o < e; o++) r.push(o);
        ...
        onPagerClick: function (t) {
          ...
          if ('UL' !== e.tagName) {
            ...
            -1 !== e.className.indexOf('more') &&
              (-1 !== e.className.indexOf('quickprev') ? (n = r - 5) : -1 !== e.className.indexOf('quicknext') && (n = r + 5)),
  ...
  (function (t, e) {
    ...
    function C(t, e, n) {
      if (Kr.errorHandler) Kr.errorHandler.call(null, t, e, n);
      else {
        if ((Zr('Error in ' + n + ': "' + t.toString() + '"', e), !la || 'undefined' == typeof console)) throw t;
        console.error(t);
      }
    }
    function $(t) {
    ...
    function S(t) {
      $a.target && Sa.push($a.target), ($a.target = t);
    }
    function T() {
      $a.target = Sa.pop();
    }
    ...
    function j(t, e) {
      if (r(t)) {
        var n;
        return (
          d(t, '__ob__') && t.__ob__ instanceof Na
            ? (n = t.__ob__)
            : ja.shouldConvert && !_a() && (Array.isArray(t) || a(t)) && Object.isExtensible(t) && !t._isVue && (n = new Na(t)),
          e && n && n.vmCount++,
          n
        );
      }
    ...
    function N(t, e, n, i) {
      ...
      if (!a || !1 !== a.configurable) {
        ...
        Object.defineProperty(t, e, {
          ...
          get: function () {
            var e = o ? o.call(t) : n;
            return $a.target && (r.depend(), l && l.dep.depend(), Array.isArray(e) && L(e)), e;
          },
          set: function (e) {
            var a = o ? o.call(t) : n;
            e === a || (e !== e && a !== a) || (i && i(), s ? s.call(t, e) : (n = e), (l = j(e)), r.notify());
          },
        });
      }
    }
    function O(t, e, n) {
      ...
      return t._isVue || (i && i.vmCount)
        ? (Zr('Avoid adding reactive properties to a Vue instance or its root $data at runtime - declare it upfront in the data option.'),
          n)
        : i
        ? (N(i.value, e, n), i.dep.notify(), n)
        : ((t[e] = n), n);
    }
    function D(t, e) {
    ...
    function L(t) {
      for (var e = void 0, n = 0, i = t.length; n < i; n++) (e = t[n]), e && e.__ob__ && e.__ob__.dep.depend(), Array.isArray(e) && L(e);
    }
    function I(t, e) {
      if (!e) return t;
      for (var n, i, r, o = Object.keys(e), s = 0; s < o.length; s++)
        (n = o[s]), (i = t[n]), (r = e[n]), d(t, n) ? a(i) && a(r) && I(i, r) : O(t, n, r);
      return t;
    }
    function M(t, e) {
    ...
    function B(t, e, n) {
      ...
      F(e), 'function' == typeof e && (e = e.options), q(e), H(e);
      var r = e.extends;
      if ((r && (t = B(t, r, n)), e.mixins)) for (var a = 0, o = e.mixins.length; a < o; a++) t = B(t, e.mixins[a], n);
      var s,
        l = {};
      for (s in t) i(s);
      for (s in e) d(t, s) || i(s);
      return l;
    }
    function R(t, e, n, i) {
      if ('string' == typeof n) {
        ...
        if (d(r, o)) return r[o];
        var s = r[n] || r[a] || r[o];
        return i && !s && Zr('Failed to resolve ' + e.slice(0, -1) + ': ' + n, t), s;
      }
    }
    function z(t, e, n, i) {
      var r = e[t],
        ...
        o = n[t];
      if (
        (Y(Boolean, r.type) && (a && !d(r, 'default') ? (o = !1) : Y(String, r.type) || ('' !== o && o !== Ur(t)) || (o = !0)),
        void 0 === o)
      ) {
        o = U(i, r, t);
        var s = ja.shouldConvert;
        (ja.shouldConvert = !0), j(o), (ja.shouldConvert = s);
      }
      return V(r, t, o, i, a), o;
    }
    function U(t, e, n) {
      if (d(e, 'default')) {
        var i = e.default;
        return (
          ...
          t && t.$options.propsData && void 0 === t.$options.propsData[n] && void 0 !== t._props[n]
            ? t._props[n]
            : 'function' == typeof i && 'Function' !== X(e.type)
            ? i.call(t)
            : i
        );
      }
    ...
    function V(t, e, n, i, r) {
      if (t.required && r) return void Zr('Missing required prop: "' + e + '"', i);
    ...
    function W(t, e) {
      var n,
        i = X(e);
      return (
        (n = Ma.test(i) ? typeof t === i.toLowerCase() : 'Object' === i ? a(t) : 'Array' === i ? Array.isArray(t) : t instanceof e),
        {
          valid: n,
          expectedType: i,
        }
    ...
    function Y(t, e) {
      ...
      for (var n = 0, i = e.length; n < i; n++) if (X(e[n]) === X(t)) return !0;
      return !1;
    }
    function J(t) {
    ...
    function G(t) {
      for (var e = t.length, n = new Array(e), i = 0; i < e; i++) n[i] = K(t[i]);
      return n;
    }
    function Q(t) {
      function e() {
    ...
    function Z(e, n, i, r, a) {
      ...
      for (o in e)
        (s = e[o]),
          ...
          (c = Ja(o)),
          t(s)
            ? Zr('Invalid handler for event "' + c.name + '": got ' + String(s), a)
            : t(l)
            ? (t(s.fns) && (s = e[o] = Q(s)), i(c.name, s, c.once, c.capture, c.passive))
            : s !== l && ((l.fns = s), (e[o] = l));
      for (o in n) t(e[o]) && ((c = Ja(o)), r(c.name, n[o], c.capture));
    }
    function tt(i, r, a) {
      function o() {
        a.apply(this, arguments), u(s.fns, o);
      }
      var s,
        l = i[r];
      t(l) ? (s = Q([o])) : e(l.fns) && n(l.merged) ? ((s = l), s.fns.push(o)) : (s = Q([l, o])), (s.merged = !0), (i[r] = s);
    }
    function et(n, i, r) {
    ...
    function nt(t, n, i, r, a) {
      if (e(n)) {
        if (d(n, i)) return (t[i] = n[i]), a || delete n[i], !0;
        if (d(n, r)) return (t[i] = n[r]), a || delete n[r], !0;
      }
      return !1;
    }
    function it(t) {
      ...
      for (a = 0; a < n.length; a++)
        (o = n[a]),
          t(o) ||
            ...
            ((s = l[l.length - 1]),
            Array.isArray(o)
              ? l.push.apply(l, at(o, (r || '') + '_' + a))
              : i(o)
              ? e(s) && e(s.text)
                ? (s.text += String(o))
                : '' !== o && l.push(J(o))
              : e(o.text) && e(s) && e(s.text)
              ? (l[l.length - 1] = J(s.text + o.text))
              : (e(o.tag) && t(o.key) && e(r) && (o.key = '__vlist' + r + '_' + a + '__'), l.push(o)));
      return l;
    }
    function ot(t, e) {
      ...
      (t.$el = e),
        t.$options.render ||
          ...
          (t.$options.template && '#' !== t.$options.template.charAt(0)) || t.$options.el || e
            ...
            : Zr('Failed to mount component: template or render function not defined.', t)),
        kt(t, 'beforeMount');
      var i;
      return (
        (i =
          Kr.performance && Da
            ? function () {
                ...
                Da(r);
                var o = t._render();
                Da(a), La(e + ' render', r, a), Da(r), t._update(o, n), Da(a), La(e + ' patch', r, a);
              }
            : function () {
    ...
    function yt(t, e, n, i, r) {
      ...
      if (
        ...
        (ja.shouldConvert = !1), (ja.isSettingProps = !0);
        for (var o = t._props, s = t.$options._propKeys || [], l = 0; l < s.length; l++) {
          var c = s[l];
          o[c] = z(c, t.$options.props, e, t);
        }
        (ja.shouldConvert = !0), (ja.isSettingProps = !1), (t.$options.propsData = e);
      }
      if (n) {
        var u = t.$options._parentListeners;
        (t.$options._parentListeners = n), pt(t, n, u);
      }
      a && ((t.$slots = ft(r, i.context)), t.$forceUpdate());
    }
    function bt(t) {
    ...
    function wt() {
      (Qa.length = Za.length = 0), (to = {}), (eo = {}), (no = io = !1);
    }
    function Ct() {
      io = !0;
      var t, e;
      for (
        Qa.sort(function (t, e) {
          return t.id - e.id;
        }),
          ro = 0;
        ro < Qa.length;
        ...
        if (((t = Qa[ro]), (e = t.id), (to[e] = null), t.run(), null != to[e] && ((eo[e] = (eo[e] || 0) + 1), eo[e] > Ga))) {
          Zr(
      ...
      var n = Za.slice(),
        i = Qa.slice();
      wt(), Tt(n), $t(i), xa && Kr.devtools && xa.emit('flush');
    }
    function $t(t) {
    ...
    function Et(t) {
      ...
      if (null == to[e]) {
        if (((to[e] = !0), io)) {
          for (var n = Qa.length - 1; n >= 0 && Qa[n].id > t.id; ) n--;
    ...
    function jt(t, e) {
      ...
      if ((a || r(t)) && Object.isExtensible(t)) {
        ...
        if (a) for (n = t.length; n--; ) jt(t[n], e);
        else for (i = Object.keys(t), n = i.length; n--; ) jt(t[i[n]], e);
      }
    }
    function Nt(t, e, n) {
      (lo.get = function () {
    ...
    function Lt(t) {
      ...
      (e = t._data = 'function' == typeof e ? It(e, t) : e || {}),
        a(e) ||
          ((e = {}), Zr('data functions should return an object:\nhttps://vuejs.org/v2/guide/components.html#data-Must-Be-a-Function', t));
      for (var n = Object.keys(e), i = t.$options.props, r = n.length; r--; )
        i && d(i, n[r])
          ? Zr('The data property "' + n[r] + '" is already declared as a prop. Use prop default value instead.', t)
          : x(n[r]) || Nt(t, '_data', n[r]);
      j(e, !0);
    }
    function It(t, e) {
      try {
    ...
    function Mt(t, e) {
      ...
      for (var i in e) {
        ...
        void 0 === a && (Zr('No getter function has been defined for computed property "' + i + '".', t), (a = g)),
          (n[i] = new oo(t, a, g, uo)),
          i in t
            ? i in t.$data
              ? Zr('The computed property "' + i + '" is already defined in data.', t)
              : t.$options.props && i in t.$options.props && Zr('The computed property "' + i + '" is already defined as a prop.', t)
            : Pt(t, i, r);
      }
    }
    function Pt(t, e, n) {
      'function' == typeof n
        ? ((lo.get = Ft(e)), (lo.set = g))
        : ((lo.get = n.get ? (!1 !== n.cache ? Ft(e) : n.get) : g), (lo.set = n.set ? n.set : g)),
        Object.defineProperty(t, e, lo);
    }
    function Ft(t) {
      return function () {
        var e = this._computedWatchers && this._computedWatchers[t];
        if (e) return e.dirty && e.evaluate(), $a.target && e.depend(), e.value;
      };
    }
    function qt(t, e) {
      ...
      for (var i in e)
        (t[i] = null == e[i] ? g : f(e[i], t)),
          null == e[i] &&
            Zr('method "' + i + '" has an undefined value in the component definition. Did you reference the function correctly?', t),
          n && d(n, i) && Zr('method "' + i + '" has already been defined as a prop.', t);
    }
    function Ht(t, e) {
      for (var n in e) {
        var i = e[n];
        if (Array.isArray(i)) for (var r = 0; r < i.length; r++) Bt(t, n, i[r]);
        else Bt(t, n, i);
      }
    }
    function Bt(t, e, n) {
    ...
    function Ut(t, e) {
      if (t) {
        for (
          var n = Array.isArray(t), i = Object.create(null), r = n ? t : ka ? Reflect.ownKeys(t) : Object.keys(t), a = 0;
          a < r.length;
          a++
        )
    ...
    function Vt(t, n, i, r, a) {
      var o = {},
        s = t.options.props;
      if (e(s)) for (var l in s) o[l] = z(l, s, n || {});
      else e(i.attrs) && Wt(o, i.attrs), e(i.props) && Wt(o, i.props);
      ...
      return (
        d instanceof Va &&
          ((d.functionalContext = r), (d.functionalOptions = t.options), i.slot && ((d.data || (d.data = {})).slot = i.slot)),
        d
      );
    }
    function Wt(t, e) {
      for (var n in e) t[Br(n)] = e[n];
    }
    function Xt(i, a, o, s, l) {
      if (!t(i)) {
        var c = o.$options._base;
        if ((r(i) && (i = c.extend(i)), 'function' != typeof i)) return void Zr('Invalid Component definition: ' + String(i), o);
        if (!t(i.cid) || void 0 !== (i = st(i, c, o))) {
          pe(i), (a = a || {}), e(a.model) && Gt(i.options, a);
          var u = et(a, i, l);
          if (n(i.options.functional)) return Vt(i, u, a, o, s);
          var d = a.on;
          (a.on = a.nativeOn), n(i.options.abstract) && (a = {}), Jt(a);
    ...
    function Qt(t, e, r, a, o, s) {
      return (Array.isArray(r) || i(r)) && ((o = a), (a = r), (r = void 0)), n(s) && (o = vo), Zt(t, e, r, a, o);
    }
    function Zt(t, n, i, r, a) {
      ...
      if ('string' == typeof n) {
        ...
        (s = Kr.getTagNamespace(n)),
          (o = Kr.isReservedTag(n)
            ? new Va(Kr.parsePlatformTagName(n), i, r, void 0, void 0, t)
            : e((l = R(t.$options, 'components', n)))
            ? Xt(l, i, t, r, n)
            : new Va(n, i, r, void 0, void 0, t));
      } else o = Xt(n, i, t, r);
      return e(o) ? (s && te(o, s), o) : Ya();
    }
    function te(n, i) {
    ...
    function ee(t, e) {
      ...
      else if (r(t)) for (o = Object.keys(t), n = new Array(o.length), i = 0, a = o.length; i < a; i++) (s = o[i]), (n[i] = e(t[s], s, i));
      return n;
    }
    function ne(t, e, n, i) {
      var r = this.$scopedSlots[t];
      if (r) return (n = n || {}), i && v(n, i), r(n) || e;
      var a = this.$slots[t];
      return (
        a &&
          (a._rendered &&
            Zr('Duplicate presence of slot "' + t + '" found in the same render tree - this will likely cause render errors.', this),
          (a._rendered = !0)),
        a || e
      );
    }
    ...
    function ae(t, e, n, i) {
      if (n)
        ...
        } else Zr('v-bind without argument expects an Object or Array value', this);
      return t;
    }
    function oe(t, e) {
    ...
    function pe(t) {
      ...
      if (t.super) {
        ...
        if (n !== t.superOptions) {
          t.superOptions = n;
          var i = fe(t);
          i && v(t.extendOptions, i), (e = t.options = B(n, t.extendOptions)), e.name && (e.components[e.name] = t);
        }
      }
      return e;
    }
    function fe(t) {
      var e,
        ...
        i = t.extendOptions,
        r = t.sealedOptions;
      for (var a in n) n[a] !== r[a] && (e || (e = {}), (e[a] = he(n[a], i[a], r[a])));
      return e;
    }
    function he(t, e, n) {
      if (Array.isArray(t)) {
    ...
    function ve(t) {
      this instanceof ve || Zr('Vue is a constructor and should be called with the `new` keyword'), this._init(t);
    }
    function me(t) {
      t.use = function (t) {
        if (!t.installed) {
    ...
    function xe(t) {
      Yr.forEach(function (e) {
        t[e] = function (t, n) {
          return n
            ? ('component' === e && Kr.isReservedTag(t) && Zr('Do not use built-in or reserved HTML elements as component id: ' + t),
              'component' === e && a(n) && ((n.name = n.name || t), (n = this.options._base.extend(n))),
              'directive' === e &&
                'function' == typeof n &&
                (n = {
                  bind: n,
    ...
    function je(n) {
      ...
      var i = '';
      if (Array.isArray(n)) {
        for (var a, o = 0, s = n.length; o < s; o++) e(n[o]) && e((a = je(n[o]))) && '' !== a && (i += a + ' ');
        return i.slice(0, -1);
      }
      if (r(n)) {
    ...
    function De(t) {
      if ('string' == typeof t) {
        ...
        return e || (Zr('Cannot find element: ' + t), document.createElement('div'));
      }
      return t;
    }
    function Le(t, e) {
      ...
      if (n) {
        ...
        e
          ? Array.isArray(a[n])
            ...
            : a[n] === r && (a[n] = void 0)
          : t.data.refInFor
          ? Array.isArray(a[n]) && a[n].indexOf(r) < 0
            ? a[n].push(r)
            : (a[n] = [r])
          : (a[n] = r);
      }
    ...
    function Ge(t, e) {
      ...
      for (n in l)
        (i = s[n]),
          (r = l[n]),
          i
            ? ((r.oldValue = i.value), tn(r, 'update', e, t), r.def && r.def.componentUpdated && u.push(r))
            : (tn(r, 'bind', e, t), r.def && r.def.inserted && c.push(r));
      if (c.length) {
        var d = function () {
      ...
      if (
        (u.length &&
          tt(e.data.hook || (e.data.hook = {}), 'postpatch', function () {
            for (var n = 0; n < u.length; n++) tn(u[n], 'componentUpdated', e, t);
          }),
        !a)
      )
        for (n in s) l[n] || tn(s[n], 'unbind', t, t, o);
    }
    function Qe(t, e) {
      ...
      for (i = 0; i < t.length; i++)
        (r = t[i]), r.modifiers || (r.modifiers = Jo), (n[Ze(r)] = r), (r.def = R(e.$options, 'directives', r.name, !0));
      return n;
    }
    function Ze(t) {
    ...
    function en(n, i) {
      if (!t(n.data.attrs) || !t(i.data.attrs)) {
        ...
        for (r in l) (a = l[r]), s[r] !== a && nn(o, r, a);
        da && l.value !== s.value && nn(o, 'value', l.value);
        for (r in s) t(l[r]) && (Io(r) ? o.removeAttributeNS(Lo, Mo(r)) : Oo(r) || o.removeAttribute(r));
      }
    }
    function nn(t, e, n) {
      Do(e)
    ...
    function rn(n, i) {
      ...
      if (!(t(a.staticClass) && t(a.class) && (t(o) || (t(o.staticClass) && t(o.class))))) {
        ...
        e(l) && (s = Ae(s, je(l))), s !== r._prevClass && (r.setAttribute('class', s), (r._prevClass = s));
      }
    }
    function an(t) {
      function e() {
      ...
      for (r = 0; r < t.length; r++)
        ...
        } else void 0 === a ? ((h = r + 1), (a = t.slice(0, r).trim())) : e();
      if ((void 0 === a ? (a = t.slice(0, r).trim()) : 0 !== h && e(), o)) for (r = 0; r < o.length; r++) a = on(a, o[r]);
      return a;
    }
    function on(t, e) {
      var n = e.indexOf('(');
    ...
    function gn(t) {
      if (((xo = t), (_o = xo.length), (wo = Co = $o = 0), t.indexOf('[') < 0 || t.lastIndexOf(']') < _o - 1))
        return {
          exp: t,
          idx: null,
        };
      for (; !bn(); ) (ko = yn()), _n(ko) ? kn(ko) : 91 === ko && xn(ko);
      return {
    ...
    function wn(t, e, n) {
      ...
      if (
        ('input' === a &&
          s &&
          So('<input :type="' + s + '" v-model="' + i + '">:\nv-model does not support dynamic input types. Use v-if branches instead.'),
        'input' === a &&
          'file' === o &&
          So('<' + t.tag + ' v-model="' + i + '" type="file">:\nFile inputs are read only. Use a v-on:change listener instead.'),
        'select' === a)
      )
        Sn(t, i, r);
      else if ('input' === a && 'checkbox' === o) Cn(t, i, r);
      else if ('input' === a && 'radio' === o) $n(t, i, r);
      else if ('input' === a || 'textarea' === a) Tn(t, i, r);
      else {
        if (!Kr.isReservedTag(a)) return vn(t, i, r), !1;
        So(
          '<' +
            t.tag +
            ' v-model="' +
    ...
    function Cn(t, e, n) {
      ...
      cn(
        t,
        'checked',
        'Array.isArray(' + e + ')?_i(' + e + ',' + r + ')>-1' + ('true' === a ? ':(' + e + ')' : ':_q(' + e + ',' + a + ')')
      ),
        pn(
          t,
          es,
    ...
    function $n(t, e, n) {
      var i = n && n.number,
        r = fn(t, 'value') || 'null';
      (r = i ? '_n(' + r + ')' : r), cn(t, 'checked', '_q(' + e + ',' + r + ')'), pn(t, es, mn(e, r), null, !0);
    }
    function Sn(t, e, n) {
      var i = n && n.number,
        r =
          ...
          '})',
        a = 'var $$selectedVal = ' + r + ';';
      (a = a + ' ' + mn(e, '$event.target.multiple ? $$selectedVal : $$selectedVal[0]')), pn(t, 'change', a, null, !0);
    }
    function Tn(t, e, n) {
    ...
    function En(t) {
      var n;
      e(t[ts]) && ((n = ua ? 'change' : 'input'), (t[n] = [].concat(t[ts], t[n] || [])), delete t[ts]),
        e(t[es]) && ((n = va ? 'click' : 'change'), (t[n] = [].concat(t[es], t[n] || [])), delete t[es]);
    }
    ...
    function Nn(e, n) {
      if (!t(e.data.on) || !t(n.data.on)) {
        var i = n.data.on || {},
          r = e.data.on || {};
        (To = n.elm), En(i), Z(i, r, An, jn, n.context);
      }
    }
    function On(n, i) {
    ...
    function Fn(t, e) {
      var n,
        i = {};
      if (e) for (var r = t; r.componentInstance; ) (r = r.componentInstance._vnode), r.data && (n = Mn(r.data)) && v(i, n);
      (n = Mn(t.data)) && v(i, n);
      for (var a = t; (a = a.parent); ) a.data && (n = Mn(a.data)) && v(i, n);
      return i;
    }
    function qn(n, i) {
      var r = i.data,
      ...
      if (!(t(r.staticStyle) && t(r.style) && t(a.staticStyle) && t(a.style))) {
        ...
        var f = Fn(i, !0);
        for (s in d) t(f[s]) && ss(l, s, '');
        for (s in f) (o = f[s]) !== d[s] && ss(l, s, null == o ? '' : o);
      }
    }
    function Hn(t, e) {
      if (e && (e = e.trim()))
    ...
    function Rn(t) {
      if (t) {
        if ('object' == typeof t) {
          var e = {};
          return !1 !== t.css && v(e, ds(t.name || 'v')), v(e, t), e;
        }
    ...
    function Vn(t, e) {
      t._transitionClasses && u(t._transitionClasses, e), Bn(t, e);
    }
    function Wn(t, e, n) {
      var i = Xn(t, e),
        r = i.type,
    ...
    function Xn(t, e) {
      var n,
        ...
        r = i[vs + 'Delay'].split(', '),
        a = i[vs + 'Duration'].split(', '),
        o = Yn(r, a),
        s = i[gs + 'Delay'].split(', '),
        l = i[gs + 'Duration'].split(', '),
        c = Yn(s, l),
        u = 0,
        d = 0;
      return (
        e === fs
          ? o > 0 && ((n = fs), (u = o), (d = a.length))
          : e === hs
          ? c > 0 && ((n = hs), (u = c), (d = l.length))
          : ((u = Math.max(o, c)), (n = u > 0 ? (o > c ? fs : hs) : null), (d = n ? (n === fs ? a.length : l.length) : 0)),
        {
          type: n,
          timeout: u,
          propCount: d,
        ...
        if (!E || k || '' === k) {
          ...
          var P = !1 !== s && !da,
            ...
            q = (a._enterCb = _(function () {
              P && (Vn(a, N), Vn(a, j)), q.cancelled ? (P && Vn(a, A), I && I(a)) : L && L(a), (a._enterCb = null);
            }));
          n.data.show ||
            tt(n.data.hook || (n.data.hook = {}), 'insert', function () {
              var t = a.parentNode,
                e = t && t._pending && t._pending[n.key];
              e && e.tag === n.tag && e.elm._leaveCb && e.elm._leaveCb(), D && D(a, q);
            }),
            O && O(a),
            P &&
              (Un(a, A),
              Un(a, j),
              zn(function () {
                Un(a, N), Vn(a, A), q.cancelled || F || (Zn(M) ? setTimeout(q, M) : Wn(a, c, q));
              })),
            n.data.show && (i && i(), D && D(a, q)),
            P || F || q();
        }
      }
    }
    function Gn(n, i) {
      function a() {
        C.cancelled ||
          (n.data.show || ((o.parentNode._pending || (o.parentNode._pending = {}))[n.key] = n),
          h && h(o),
          x &&
            (Un(o, d),
            Un(o, f),
            zn(function () {
              Un(o, p), Vn(o, d), C.cancelled || k || (Zn(w) ? setTimeout(C, w) : Wn(o, u, C));
            })),
          v && v(o, C),
          x || k || C());
      }
      ...
      if (!e(o._leaveCb) && 1 === o.nodeType) {
        ...
        var C = (o._leaveCb = _(function () {
          o.parentNode && o.parentNode._pending && (o.parentNode._pending[n.key] = null),
            x && (Vn(o, p), Vn(o, f)),
            C.cancelled ? (x && Vn(o, d), g && g(o)) : (i(), m && m(o)),
            (o._leaveCb = null);
        }));
        y ? y(a) : a();
      }
    ...
    function Qn(t, e, n) {
      'number' != typeof t
        ? Zr('<transition> explicit ' + e + ' duration is not a valid number - got ' + JSON.stringify(t) + '.', n.context)
        : isNaN(t) && Zr('<transition> explicit ' + e + ' duration is NaN - the duration expression might be incorrect.', n.context);
    }
    function Zn(t) {
    ...
    function ni(t, e, n) {
      ...
      for (var a, o, s = 0, l = t.options.length; s < l; s++)
        if (((o = t.options[s]), r)) (a = b(i, ri(o)) > -1), o.selected !== a && (o.selected = a);
        else if (y(ri(o), i)) return void (t.selectedIndex !== s && (t.selectedIndex = s));
      r || (t.selectedIndex = -1);
    }
    function ii(t, e) {
      for (var n = 0, i = e.length; n < i; n++) if (y(ri(e[n]), t)) return !1;
      return !0;
    }
    function ri(t) {
    ...
    function oi(t) {
      (t.target.composing = !1), si(t.target, 'input');
    }
    function si(t, e) {
    ...
    function bi(t, e) {
      ...
      function i(t, n, i) {
        ...
        if (r >= 0) {
          for (var l = o.length - 1; l >= r; l--)
            (l > r || !t) && e.warn && e.warn('tag <' + o[l].tag + '> has no matching end tag.'), e.end && e.end(o[l].tag, n, i);
      ...
      for (var r, a, o = [], s = e.expectHTML, l = e.isUnaryTag || Vr, c = e.canBeLeftOpenTag || Vr, u = 0; t; ) {
        if (((r = t), a && vl(a))) {
          ...
          (u += t.length - h.length), (t = h), i(d, u - f, u);
        } else {
          var v = t.indexOf('<');
          if (0 === v) {
            if (Ys.test(t)) {
            ...
            var x = (function () {
              ...
              if (e) {
                ...
                n(e[0].length);
                for (var r, a; !(r = t.match(Vs)) && (a = t.match(Bs)); ) n(a[0].length), i.attrs.push(a);
    ...
    function _i(t, e) {
      ...
      if (n.test(t)) {
        for (var i, r, a = [], o = (n.lastIndex = 0); (i = n.exec(t)); ) {
          (r = i.index), r > o && a.push(JSON.stringify(t.slice(o, r)));
          var s = an(i[1].trim());
      ...
      return (
        bi(t, {
          ...
          start: function (t, s, u) {
            ...
            if ((l || (ki(f), f.pre && (l = !0)), nl(f.tag) && (c = !0), l)) wi(f);
            else {
              Si(f), Ti(f), Ni(f), Ci(f), (f.plain = !f.key && !s.length), $i(f), Oi(f), Di(f);
              for (var v = 0; v < Zs.length; v++) Zs[v](f, e);
              Li(f);
            }
            if (
              (r
                ? o.length ||
                  (r.if && (f.elseif || f.else)
                    ? (d(f),
                      ji(r, {
                        exp: f.elseif,
                        block: f,
            ...
            e && 3 === e.type && ' ' === e.text && !c && t.children.pop(), (o.length -= 1), (a = o[o.length - 1]), i(t);
          },
          chars: function (e) {
            if (!a)
              return void (e === t
    ...
    function Ci(t) {
      var e = fn(t, 'key');
      e && ('template' === t.tag && Gs('<template> cannot be keyed. Place the key on real elements instead.'), (t.key = e));
    }
    function $i(t) {
      var e = fn(t, 'ref');
    ...
    function Si(t) {
      ...
      if ((e = hn(t, 'v-for'))) {
        var n = e.match($l);
        if (!n) return void Gs('Invalid v-for expression: ' + e);
        t.for = n[2].trim();
        var i = n[1].trim(),
          r = i.match(Sl);
    ...
    function Ai(t) {
      for (var e = t.length; e--; ) {
        ...
        ' ' !== t[e].text && Gs('text "' + t[e].text.trim() + '" between v-if and v-else(-if) will be ignored.'), t.pop();
      }
    }
    function ji(t, e) {
    ...
    function Li(t) {
      ...
      for (e = 0, n = l.length; e < n; e++)
        if (((i = r = l[e].name), (a = l[e].value), Cl.test(i)))
          if (((t.hasBindings = !0), (o = Mi(i)), o && (i = i.replace(Al, '')), El.test(i)))
            (i = i.replace(El, '')),
              (a = an(a)),
              (s = !1),
              o &&
                (o.prop && ((s = !0), 'innerHtml' === (i = Br(i)) && (i = 'innerHTML')),
                o.camel && (i = Br(i)),
                o.sync && pn(t, 'update:' + Br(i), mn(a, '$event'))),
              s || il(t.tag, t.attrsMap.type, i) ? cn(t, i, a) : un(t, i, a);
          else if (wl.test(i)) (i = i.replace(wl, '')), pn(t, i, a, o, !1, Gs);
          else {
            i = i.replace(Cl, '');
            var c = i.match(Tl),
              u = c && c[1];
            u && (i = i.slice(0, -(u.length + 1))), dn(t, i, r, a, u, o), 'model' === i && Bi(t, a);
          }
        else {
          var d = _i(a, Qs);
          d &&
    ...
    function Pi(t) {
      for (var e = {}, n = 0, i = t.length; n < i; n++)
        !e[t[n].name] || ua || pa || Gs('duplicate attribute: ' + t[n].name), (e[t[n].name] = t[n].value);
      return e;
    }
    function Fi(t) {
    ...
    function Hi(t) {
      for (var e = [], n = 0; n < t.length; n++) {
        var i = t[n];
        Nl.test(i.name) || ((i.name = i.name.replace(Ol, '')), e.push(i));
      }
      return e;
    }
    function Bi(t, e) {
    ...
    function Ri(t, e) {
      t && ((al = Dl(e.staticKeys || '')), (ol = e.isReservedTag || Vr), Ui(t), Vi(t, !1));
    }
    function zi(t) {
    ...
    function Ui(t) {
      if (((t.static = Xi(t)), 1 === t.type)) {
        if (!ol(t.tag) && 'slot' !== t.tag && null == t.attrsMap['inline-template']) return;
        for (var e = 0, n = t.children.length; e < n; e++) {
          var i = t.children[e];
          Ui(i), i.static || (t.static = !1);
        }
      }
    }
    function Vi(t, e) {
    ...
    function Xi(t) {
      return (
        2 !== t.type &&
        (3 === t.type || !(!t.pre && (t.hasBindings || t.if || t.for || Fr(t.tag) || !ol(t.tag) || Yi(t) || !Object.keys(t).every(al))))
      );
    }
    function Yi(t) {
      for (; t.parent; ) {
    ...
    function Ki(t, e) {
      ...
      if (e.modifiers) {
        var r = '',
          a = '',
          o = [];
        for (var s in e.modifiers) Fl[s] ? ((a += Fl[s]), Ml[s] && o.push(s)) : o.push(s);
        o.length && (r += Gi(o)), a && (r += a);
    ...
    function er(t) {
      if (t.staticRoot && !t.staticProcessed) return nr(t);
      if (t.once && !t.onceProcessed) return ir(t);
      if (t.for && !t.forProcessed) return or(t);
      if (t.if && !t.ifProcessed) return rr(t);
      if ('template' !== t.tag || t.slotTarget) {
        if ('slot' === t.tag) return yr(t);
        var e;
        if (t.component) e = br(t.component, t);
        else {
          var n = t.plain ? void 0 : sr(t),
            i = t.inlineTemplate ? null : pr(t, !0);
          e = "_c('" + t.tag + "'" + (n ? ',' + n : '') + (i ? ',' + i : '') + ')';
        }
        for (var r = 0; r < ll.length; r++) e = ll[r](t, e);
        return e;
      }
      return pr(t) || 'void 0';
    }
    ...
    function ir(t) {
      if (((t.onceProcessed = !0), t.if && !t.ifProcessed)) return rr(t);
      if (t.staticInFor) {
        ...
        return e
          ? '_o(' + er(t) + ',' + fl++ + (e ? ',' + e : '') + ')'
          : (sl('v-once can only be used inside v-for that is keyed. '), er(t));
      }
      return nr(t);
    }
    function rr(t) {
      return (t.ifProcessed = !0), ar(t.ifConditions.slice());
    }
    function ar(t) {
      function e(t) {
    ...
    function cr(t) {
      var e = t.children[0];
      if (
        ((t.children.length > 1 || 1 !== e.type) && sl('Inline-template components must have exactly one child element.'), 1 === e.type)
      ) {
        var n = tr(e, hl);
        return (
    ...
    function wr(t, e) {
      if (1 === t.type) {
        ...
        if (t.children) for (var r = 0; r < t.children.length; r++) wr(t.children[r], e);
      } else 2 === t.type && Tr(t.expression, t.text, e);
    }
    function Cr(t, e, n) {
      var i = t.replace(zl, ''),
        r = i.match(Bl);
      r &&
        '$' !== i.charAt(r.index - 1) &&
        n.push('avoid using JavaScript unary operator as property name: "' + r[0] + '" in expression ' + e.trim()),
        Tr(t, e, n);
    }
    function $r(t, e, n) {
      Tr(t.for || '', e, n),
            ...
            e
              .map(function (t, e) {
                return (
                  '' +
                  (0 === e ? '---\x3e ' : aa(' ', 5 + 2 * e)) +
                  (Array.isArray(t) ? ea(t[0]) + '... (' + t[1] + ' recursive calls)' : ea(t))
                );
              })
              .join('\n')
          );
    ...
    var ya,
      ba,
      _a = function () {
        return void 0 === ya && (ya = !la && 'undefined' != typeof global && 'server' === global.process.env.VUE_ENV), ya;
      },
      xa = la && window.__VUE_DEVTOOLS_GLOBAL_HOOK__,
      ka = 'undefined' != typeof Symbol && $(Symbol) && 'undefined' != typeof Reflect && $(Reflect.ownKeys),
      wa = (function () {
        function t() {
          i = !1;
          var t = n.slice(0);
        ...
        if ('undefined' != typeof Promise && $(Promise)) {
          ...
          e = function () {
            r.then(t).catch(a), ha && setTimeout(g);
          };
        } else if (
          'undefined' == typeof MutationObserver ||
          (!$(MutationObserver) && '[object MutationObserverConstructor]' !== MutationObserver.toString())
        )
          e = function () {
            setTimeout(t, 0);
          };
    ...
    var Aa = Object.getOwnPropertyNames(Ea),
      ...
      Na = function (t) {
        if (((this.value = t), (this.dep = new $a()), (this.vmCount = 0), k(t, '__ob__', this), Array.isArray(t))) {
          (sa ? E : A)(t, Ea, Aa), this.observeArray(t);
        } else this.walk(t);
      };
    ...
    (Oa.el = Oa.propsData =
      function (t, e, n, i) {
        return n || Zr('option "' + i + '" can only be used during instance creation with the `new` keyword.'), Ia(t, e);
      }),
      (Oa.data = function (t, e, n) {
        return n
          ...
          : e
          ? 'function' != typeof e
            ? (Zr('The "data" option should be a function that returns a per-instance value in component definitions.', n), t)
            : t
            ? function () {
    ...
    var Da,
      ...
      Ma = /^(String|Number|Boolean|Function|Symbol)$/,
      Pa = la && window.performance;
    Pa &&
      Pa.mark &&
      Pa.measure &&
      Pa.clearMarks &&
      ...
      (La = function (t, e, n) {
        Pa.measure(t, e, n), Pa.clearMarks(e), Pa.clearMarks(n), Pa.clearMeasures(t);
      }));
    var Fa,
      qa = c(
    ...
    if (Ba) {
      ...
      Kr.keyCodes = new Proxy(Kr.keyCodes, {
        set: function (t, e, n) {
          return Ra(e) ? (Zr('Avoid overwriting built-in modifier in config.keyCodes: .' + e), !1) : ((t[e] = n), !0);
        },
      });
    }
    var za = {
    ...
    (oo.prototype.get = function () {
      ...
      return this.deep && At(t), T(), this.cleanupDeps(), t;
    }),
    ...
    var so = new ba(),
      ...
      po = {
        ...
        insert: function (t) {
          ...
          n._isMounted || ((n._isMounted = !0), kt(n, 'mounted')), t.data.keepAlive && (e._isMounted ? St(n) : _t(n, !0));
        },
        destroy: function (t) {
    ...
    !(function (t) {
      t.prototype._init = function (t) {
        ...
        e._uid = mo++;
        var n, i;
        Kr.performance && Da && ((n = 'vue-perf-init:' + e._uid), (i = 'vue-perf-end:' + e._uid), Da(n)),
          (e._isVue = !0),
          ...
          Rt(e),
          kt(e, 'created'),
          Kr.performance && Da && ((e._name = ea(e, !1)), Da(i), La(e._name + ' init', n, i)),
      ...
      (function (t) {
        ...
        (t.prototype.$on = function (t, n) {
          var i = this,
            r = this;
          if (Array.isArray(t)) for (var a = 0, o = t.length; a < o; a++) i.$on(t[a], n);
          ...
          (t.prototype.$emit = function (t) {
            ...
            if (i) {
              i = i.length > 1 ? h(i) : i;
              for (var r = h(arguments, 1), a = 0, o = i.length; a < o; a++) i[a].apply(e, r);
            }
            return e;
          });
      })(ve),
        ...
        (t.prototype.$nextTick = function (t) {
          ...
          (t.prototype._render = function () {
            var t = this,
              ...
              i = e.staticRenderFns,
              r = e._parentVnode;
            if (t._isMounted) for (var a in t.$slots) t.$slots[a] = G(t.$slots[a]);
            (t.$scopedSlots = (r && r.data.scopedSlots) || Gr), i && !t._staticTrees && (t._staticTrees = []), (t.$vnode = r);
            var o;
            try {
            ...
            return (
              o instanceof Va ||
                (Array.isArray(o) &&
                  Zr('Multiple root nodes returned from render function. Render function should return a single root node.', t),
                (o = Ya())),
              (o.parent = r),
              o
            );
    ...
    var go = [String, RegExp],
      yo = {
        ...
        render: function () {
          ...
          if (e) {
            var n = ke(e);
            if (n && ((this.include && !we(this.include, n)) || (this.exclude && we(this.exclude, n)))) return t;
    ...
    var _o,
      ...
      Eo,
      Ao = c('style,class'),
      jo = c('input,textarea,option,select'),
      No = function (t, e, n) {
        return (
      ...
      Oo = c('contenteditable,draggable,spellcheck'),
      Do = c(
      ...
      ss = function (t, e, n) {
        ...
        else if (os.test(n)) t.style.setProperty(e, n.replace(os, ''), 'important');
        else {
          var i = cs(e);
          if (Array.isArray(n)) for (var r = 0, a = n.length; r < a; r++) t.style[i] = n[r];
          else t.style[i] = n;
        }
      },
      ls = ['Webkit', 'Moz', 'ms'],
      cs = p(function (t) {
        if (((Eo = Eo || document.createElement('div')), 'filter' !== (t = Br(t)) && t in Eo.style)) return t;
        for (var e = t.charAt(0).toUpperCase() + t.slice(1), n = 0; n < ls.length; n++) {
          var i = ls[n] + e;
          if (i in Eo.style) return i;
        }
      }),
      us = {
        create: qn,
    ...
    ps &&
      (void 0 === window.ontransitionend &&
        ...
        ((vs = 'WebkitTransition'), (ms = 'webkitTransitionEnd')),
      void 0 === window.onanimationend &&
        void 0 !== window.onwebkitanimationend &&
        ((gs = 'WebkitAnimation'), (ys = 'webkitAnimationEnd')));
    var bs = la && window.requestAnimationFrame ? window.requestAnimationFrame.bind(window) : setTimeout,
      ...
      Cs = (function (r) {
          ...
          if (((t.isRootInsert = !o), !u(t, i, r, a))) {
            ...
            e(c)
              ? (s && s.pre && O++,
                O ||
                  t.ns ||
                  (Kr.ignoredElements.length && Kr.ignoredElements.indexOf(c) > -1) ||
                  !Kr.isUnknownElement(c) ||
                  Zr(
                ...
                s && s.pre && O--)
              : n(t.isComment)
              ? ((t.elm = N.createComment(t.text)), f(r, t.elm, a))
              : ((t.elm = N.createTextNode(t.text)), f(r, t.elm, a));
          }
        }
        function u(t, i, r, a) {
          var o = t.data;
          if (e(o)) {
            ...
            if ((e((o = o.hook)) && e((o = o.init)) && o(t, !1, r, a), e(t.componentInstance))) return d(t, i), n(s) && p(t, i, r, a), !0;
          }
        }
        function d(t, n) {
        ...
        function p(t, n, i, r) {
          for (var a, o = t; o.componentInstance; )
            if (((o = o.componentInstance._vnode), e((a = o.data)) && e((a = a.transition)))) {
              for (a = 0; a < A.activate.length; ++a) A.activate[a](Wo, o);
              n.push(o);
              break;
            }
          f(i, t.elm, r);
        ...
        function h(t, e, n) {
          if (Array.isArray(e)) for (var r = 0; r < e.length; ++r) l(e[r], n, t.elm, null, !0);
          else i(t.text) && N.appendChild(t.elm, N.createTextNode(t.text));
        }
        function v(t) {
        ...
        function m(t, n) {
          for (var i = 0; i < A.create.length; ++i) A.create[i](Wo, t);
          (T = t.data.hook), e(T) && (e(T.create) && T.create(Wo, t), e(T.insert) && n.push(t));
        }
        function g(t) {
          for (var n, i = t; i; ) e((n = i.context)) && e((n = n.$options._scopeId)) && N.setAttribute(t.elm, n, ''), (i = i.parent);
        ...
        function b(t) {
          var n,
            i,
            r = t.data;
          if (e(r)) for (e((n = r.hook)) && e((n = n.destroy)) && n(t), n = 0; n < A.destroy.length; ++n) A.destroy[n](t);
          if (e((n = t.children))) for (i = 0; i < t.children.length; ++i) b(t.children[i]);
        }
        function _(t, n, i, r) {
          for (; i <= r; ++i) {
            var a = n[i];
            e(a) && (e(a.tag) ? (x(a), b(a)) : s(a.elm));
          }
        }
        function x(t, n) {
          if (e(n) || e(t.data)) {
        ...
        function k(n, i, r, a, o) {
          for (
            var s, c, u, d, p = 0, f = 0, h = i.length - 1, v = i[0], m = i[h], g = r.length - 1, b = r[0], x = r[g], k = !o;
            p <= h && f <= g;
            ...
            t(v)
              ...
              ? (w(m, x, a), (m = i[--h]), (x = r[--g]))
              : Xe(v, x)
              ? (w(v, x, a), k && N.insertBefore(n, v.elm, N.nextSibling(m.elm)), (v = i[++p]), (x = r[--g]))
              : Xe(m, b)
              ? (w(m, b, a), k && N.insertBefore(n, m.elm, v.elm), (m = i[--h]), (b = r[++f]))
              : (t(s) && (s = Je(i, p, h)),
                ...
                t(c)
                  ...
                  : ((u = i[c]),
                    u ||
                      Zr('It seems there are duplicate keys that is causing an update error. Make sure each v-for item has a unique key.'),
                    Xe(u, b)
                      ? (w(u, b, a), (i[c] = void 0), k && N.insertBefore(n, b.elm, v.elm), (b = r[++f]))
                      : (l(b, a, n, v.elm), (b = r[++f]))));
          p > h ? ((d = t(r[g + 1]) ? null : r[g + 1].elm), y(n, d, r, f, g, a)) : f > g && _(n, i, p, h);
        }
        function w(i, r, a, o) {
          if (i !== r) {
            if (n(r.isStatic) && n(i.isStatic) && r.key === i.key && (n(r.isCloned) || n(r.isOnce)))
              return (r.elm = i.elm), void (r.componentInstance = i.componentInstance);
            var s,
              l = r.data;
            ...
            var c = (r.elm = i.elm),
              ...
              d = r.children;
            if (e(l) && v(r)) {
              for (s = 0; s < A.update.length; ++s) A.update[s](i, r);
            ...
            t(r.text)
              ? e(u) && e(d)
                ? u !== d && k(c, u, d, a, o)
                : e(d)
                ? (e(i.text) && N.setTextContent(c, ''), y(c, null, d, 0, d.length - 1, a))
                : e(u)
                ? _(c, u, 0, u.length - 1)
                : e(i.text) && N.setTextContent(c, '')
              : i.text !== r.text && N.setTextContent(c, r.text),
              e(l) && e((s = l.hook)) && e((s = s.postpatch)) && s(i, r);
          }
        }
        function C(t, i, r) {
          if (n(r) && e(t.parent)) t.parent.data.pendingInsert = i;
          else for (var a = 0; a < i.length; ++a) i[a].data.hook.insert(i[a]);
        }
        function $(t, n, i) {
          if (!S(t, n)) return !1;
          n.elm = t;
          var r = n.tag,
            a = n.data,
            o = n.children;
          if (e(a) && (e((T = a.hook)) && e((T = T.init)) && T(n, !0), e((T = n.componentInstance)))) return d(n, i), !0;
          if (e(r)) {
            if (e(o))
              if (t.hasChildNodes()) {
                ...
                if (!s || l)
                  return (
                    'undefined' == typeof console ||
                      D ||
                      ((D = !0), console.warn('Parent: ', t), console.warn('Mismatching childNodes vs. VNodes: ', t.childNodes, o)),
                    !1
                  );
              } else h(n, o, i);
            if (e(a))
        ...
        var T,
          ...
          j = r.modules,
          N = r.nodeOps;
        for (T = 0; T < Xo.length; ++T) for (A[Xo[T]] = [], E = 0; E < j.length; ++E) e(j[E][Xo[T]]) && A[Xo[T]].push(j[E][Xo[T]]);
        var O = 0,
          D = !1,
          L = c('attrs,style,class,staticClass,staticStyle,key');
        return function (i, r, o, s, c, u) {
          if (t(r)) return void (e(i) && b(i));
          var d = !1,
            p = [];
          if (t(i)) (d = !0), l(r, p, c, u);
          else {
            var f = e(i.nodeType);
            if (!f && Xe(i, r)) w(i, r, p, s);
            else {
              if (f) {
                if ((1 === i.nodeType && i.hasAttribute(Xr) && (i.removeAttribute(Xr), (o = !0)), n(o))) {
                  if ($(i, r, p)) return C(r, p, !0), i;
                  Zr(
              ...
              var h = i.elm,
                m = N.parentNode(h);
              if ((l(r, p, h._leaveCb ? null : m, N.nextSibling(h)), e(r.parent))) {
                for (var g = r.parent; g; ) (g.elm = r.elm), (g = g.parent);
                if (v(r)) for (var y = 0; y < A.create.length; ++y) A.create[y](Wo, r.parent);
              }
              e(m) ? _(m, [i], 0, 0) : e(i.tag) && b(i);
            }
          }
          return C(r, p, d), r.elm;
        };
      })({
        nodeOps: Uo,
        modules: ws,
    ...
    var $s = {
        inserted: function (t, e, n) {
          if ('select' === n.tag) {
            ...
            i(), (ua || pa) && setTimeout(i, 0);
          } else
            ('textarea' !== n.tag && 'text' !== t.type && 'password' !== t.type) ||
              ((t._vModifiers = e.modifiers),
              e.modifiers.lazy ||
                (t.addEventListener('change', oi),
                fa || (t.addEventListener('compositionstart', ai), t.addEventListener('compositionend', oi)),
                da && (t.vmodel = !0)));
        },
      ...
      As = {
        ...
        render: function (t) {
          ...
          if (
            ...
            var a = n[0];
            if (pi(this.$vnode)) return a;
            var o = ci(a);
            if (!o) return a;
            if (this._leaving) return di(t, a);
        ...
        render: function (t) {
          ...
          if (i) {
            for (var d = [], p = [], f = 0; f < i.length; f++) {
              var h = i[f];
              (h.data.transition = o), (h.data.pos = h.elm.getBoundingClientRect()), n[h.key] ? d.push(h) : p.push(h);
            }
                ...
                Un(n, e),
                  ...
                  n.addEventListener(
                    ...
                    (n._moveCb = function t(i) {
                      (i && !/transform$/.test(i.propertyName)) || (n.removeEventListener(ms, t), (n._moveCb = null), Vn(n, e));
                    })
                  );
              }
            });
    ...
    (ve.config.mustUseProp = No),
      ...
      (ve.prototype.$mount = function (t, e) {
        return (t = t && la ? De(t) : void 0), gt(this, t, e);
      }),
      setTimeout(function () {
        Kr.devtools &&
          (xa
    ...
    var Ds,
      ...
      Is = c('area,base,br,col,embed,frame,hr,img,input,isindex,keygen,link,meta,param,source,track,wbr'),
      Ms = c('colgroup,dd,dt,li,options,p,td,tfoot,th,thead,tr,source'),
      Ps = c(
        'address,article,aside,base,blockquote,body,caption,col,colgroup,dd,details,dialog,div,dl,dt,fieldset,figcaption,figure,footer,form,h1,h2,h3,h4,h5,h6,head,header,hgroup,hr,html,legend,li,menuitem,meta,optgroup,option,param,rp,rt,source,style,summary,tbody,td,tfoot,th,thead,title,tr,track'
      ),
      Fs = /([^\s"'<>\/=]+)/,
      qs = /(?:=)/,
      Hs = [/"([^"]*)"+/.source, /'([^']*)'+/.source, /([^\s"'=<>`]+)/.source],
      Bs = new RegExp('^\\s*' + Fs.source + '(?:\\s*(' + qs.source + ')\\s*(?:' + Hs.join('|') + '))?'),
      Rs = '[a-zA-Z_][\\w\\-\\.]*',
      zs = '((?:' + Rs + '\\:)?' + Rs + ')',
      Us = new RegExp('^<' + zs),
      Vs = /^\s*(\/?)>/,
    ...
    var Gs,
      ...
      Ol = /^NS\d+:/,
      Dl = p(zi),
      Ll = /^\s*([\w$_]+|\([^)]*?\))\s*=>|^function\s*\(/,
      Il = /^\s*[A-Za-z_$][\w$]*(?:\.[A-Za-z_$][\w$]*|\['.*?']|\[".*?"]|\[\d+]|\[[A-Za-z_$][\w$]*])*\s*$/,
      Ml = {
        esc: 27,
        tab: 9,
        enter: 13,
      ...
      Bl = new RegExp('\\b' + 'delete,typeof,void'.split(',').join('\\s*\\([^\\)]*\\)|\\b') + '\\s*\\([^\\)]*\\)'),
      Rl = /[A-Za-z_$][\w$]*/,
      zl = /'(?:[^'\\]|\\.)*'|"(?:[^"\\]|\\.)*"|`(?:[^`\\]|\\.)*\$\{|\}(?:[^`\\]|\\.)*`|`(?:[^`\\]|\\.)*`/g,
      Ul = {
      ...
      Jl = (function (t) {
        function e(e, n) {
          ...
          var s = Er(e, i);
          return r.push.apply(r, kr(s.ast)), (s.errors = r), (s.tips = a), s;
        }
        function n(t, n, r) {
          n = n || {};
          try {
          ...
          for (var u = 0; u < c; u++) s.staticRenderFns[u] = Ar(o.staticRenderFns[u], l);
          return (
    ...
    return (
      (ve.prototype.$mount = function (t, e) {
        if ((t = t && De(t)) === document.body || t === document.documentElement)
          return Zr('Do not mount Vue to <html> or <body> - mount to normal elements instead.'), this;
        var n = this.$options;
        if (!n.render) {
          var i = n.template;
          if (i)
            if ('string' == typeof i)
              ...
              if (!i.nodeType) return Zr('invalid template option:' + i, this), this;
              i = i.innerHTML;
            }
          else t && (i = Mr(t));
          if (i) {
            ...
            (n.render = a),
              (n.staticRenderFns = o),
              Kr.performance && Da && (Da('compile end'), La(this._name + ' compile', 'compile', 'compile end'));
          }
        }
  ...
  define('../lib/tip-vue', ['require', 'exports', 'module', 'Vue', 'vue_tip'], function (t, e, n) {
    ...
    (l.close = function (t, e) {
      for (var n = 0, i = o.length; n < i; n++)
        if (t === o[n].id) {
          'function' == typeof e && e(o[n]), o.splice(n, 1);
          break;
        }
    }),
      (l.closeAll = function () {
        for (var t = o.length - 1; t >= 0; t--) o[t].close();
      }),
      (n.exports = l);
  }),
  (function (t) {
        ...
        3: [
          function (t, e, n) {
            ...
            var i = t('./utils'),
              ...
              o = function (t, e) {
                for (
                  var n = {}, i = t.split(e.delimiter, e.parameterLimit === 1 / 0 ? void 0 : e.parameterLimit), a = 0;
                  a < i.length;
                  ++a
                ) {
                  var o,
                  ...
                  -1 === c
                    ? ((o = e.decoder(l)), (s = e.strictNullHandling ? null : ''))
                    : ((o = e.decoder(l.slice(0, c))), (s = e.decoder(l.slice(c + 1)))),
              ...
              s = function (t, e, n) {
                ...
                var i,
                  r = t.shift();
                if ('[]' === r) (i = []), (i = i.concat(s(t, e, n)));
                else {
                  i = n.plainObjects ? Object.create(null) : {};
                  var a = '[' === r.charAt(0) && ']' === r.charAt(r.length - 1) ? r.slice(1, -1) : r,
                    o = parseInt(a, 10);
                  !isNaN(o) && r !== a && String(o) === a && o >= 0 && n.parseArrays && o <= n.arrayLimit
                    ? ((i = []), (i[o] = s(t, e, n)))
                    : (i[a] = s(t, e, n));
                }
                return i;
              ...
              l = function (t, e, n) {
                if (t) {
                  ...
                  return l && u.push('[' + i.slice(l.index) + ']'), s(u, e, n);
                }
              };
            e.exports = function (t, e) {
              ...
              if (
                ((n.delimiter = 'string' == typeof n.delimiter || i.isRegExp(n.delimiter) ? n.delimiter : a.delimiter),
              ...
              for (
                var r = 'string' == typeof t ? o(t, n) : t, s = n.plainObjects ? Object.create(null) : {}, c = Object.keys(r), u = 0;
                u < c.length;
                ++u
              ) {
                var d = c[u],
            ...
            var i = t('./utils'),
              ...
              l = function t(e, n, r, a, o, s, l, c, u, d, p, f) {
                ...
                for (var y = 0; y < m.length; ++y) {
                  ...
                  (o && null === h[b]) ||
                    (v = Array.isArray(h)
                      ? v.concat(t(h[b], r(n, b), r, a, o, s, l, c, u, d, p, f))
                      : v.concat(t(h[b], n + (u ? '.' + b : '[' + b + ']'), r, a, o, s, l, c, u, d, p, f)));
                }
                return v;
              };
            e.exports = function (t, e) {
          ...
          function (t, e, n) {
            ...
            (n.arrayToObject = function (t, e) {
              ...
              (n.merge = function (t, e, r) {
                ...
                var a = t;
                return (
                  Array.isArray(t) && !Array.isArray(e) && (a = n.arrayToObject(t, r)),
                  Array.isArray(t) && Array.isArray(e)
                    ...
                    : Object.keys(e).reduce(function (t, i) {
                        var a = e[i];
                        return Object.prototype.hasOwnProperty.call(t, i) ? (t[i] = n.merge(t[i], a, r)) : (t[i] = a), t;
                      }, a)
                );
              }),
              (n.decode = function (t) {
              ...
              (n.encode = function (t) {
                ...
                for (var e = 'string' == typeof t ? t : String(t), n = '', i = 0; i < e.length; ++i) {
                  ...
                  45 === a || 46 === a || 95 === a || 126 === a || (a >= 48 && a <= 57) || (a >= 65 && a <= 90) || (a >= 97 && a <= 122)
                    ...
                    : a < 55296 || a >= 57344
                    ? (n += r[224 | (a >> 12)] + r[128 | ((a >> 6) & 63)] + r[128 | (63 & a)])
                    : ((i += 1),
        ...
        (l = l || 'mindgo'),
          ...
          (t.callback = function () {
            if (t.act) {
              ...
              a && (e.ld = o ? 'ifind_g' : 'ifind_s'), d && (e.targid = d), TA.log(e);
            }
          }),
...
define('../common/vueDirectives2', ['require', 'exports', 'module', 'Vue'], function (t, e, n) {
        ...
        __creator: function (t) {
          $(t).data($.zUI.draggable.sEventName, {
            mousedown: function (t) {
              function e(t) {
                var e = {};
                i.fnComputePosition ? (e = i.fnComputePosition(t, r, a)) : ((e.iLeft = t.pageX - r), (e.iTop = t.pageY - a));
                var o = i.oBoundary;
                ...
                o &&
                  ((e.iLeft = e.iLeft < o.iMinLeft ? o.iMinLeft : e.iLeft),
              ...
              var r = t.pageX - this.offsetLeft,
                ...
                o = {
                  mousemove: e,
                  mouseup: function () {
                    $(document).off(o), n.trigger('draggable.stop');
                  },
                };
              $(document).on(o);
            },
      ...
      $.zUI.addWidget('panel', {
        ...
        __creator: function (t) {
          function e(t, e, n, r, a, o) {
            ...
            r.css('top', c), s.bottomCallback && -1 === l && s.bottomCallback();
          }
          function n() {
            var t = i.data($.zUI.panel.sOptsName),
              ...
              o = Math.round(a * n);
            if (a >= 1) return s.css('height', 0), void l.css('height', 0);
            s.css('height', n), l.css('height', o);
            var c = {
              iMinTop: t.iTop,
            };
          ...
          if (r.length) {
            ...
            var c = {
                mouseenter: function () {
                  n(), s.css('display', 'block'), l.css('display', 'block');
                },
                mouseleave: function () {
                  s.css('display', 'none'), l.css('display', o ? 'block' : 'none');
                },
              },
              u = 'mousewheel';
            'onmousewheel' in document || (u = 'DOMMouseScroll'),
              (c[u] = function (t) {
                var n = i.data($.zUI.panel.sOptsName),
                  a = 1;
                t.preventDefault(), (t = t.originalEvent), (a = t.wheelDelta ? t.wheelDelta / 120 : -t.detail / 3);
                var o = i.innerHeight() - r.outerHeight();
                if (o > 0) return void r.css('top', 0);
                var c = parseInt(r.css('top'));
                (c += n.iWheelStep * a), (c = c > 0 ? 0 : c), (c = c < o ? o : c), r.css('top', c), e(i, r, s, l, 0, n.iTop);
              }),
  ...
  require([
    'jquery',
    '../router/strategy-lib-router',
    '../vuex/strategy-lib/strategy-lib',
    '../common/vueComponents',
    '../common/vueDirectives',
    '../common/vueDirectives2',
    '../lib/zUI',
  ], function (t, e, n) {
    t('#main_header_study').addClass('header-nav-item-active'), t('#strategy_lib').addClass('item-active');
    var i = t(window).height();
    t('#main-container').css('height', 'calc(100% - 55px)'),
      t(window).on('resize', function () {
        t('#strategy_lib').addClass('item-active'), (i = t(window).height()), t('#main-container').css('height', 'calc(100% - 55px)');
      }),
      new Vue({
