...
export default function Sidebar() {
  ...
  return (
    <>
      <nav className="md:left-0 md:block min-h-[600px] md:fixed md:top-0 z-50 md:bottom-0 md:overflow-y-auto md:flex-row md:flex-nowrap md:overflow-hidden shadow-xl bg-white flex flex-wrap items-center justify-between relative md:w-64 z-10 py-4 px-6">
